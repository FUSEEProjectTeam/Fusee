...
namespace Fusee.Math
{
    ...
    public sealed class ArrayConvert
    {
        ...
        public static float[] float4x4ToArrayFloatColOrder(Fusee.Math.Core.float4x4 value)
        {
        ...
        /// <summary>
        /// Converts a <see cref="Fusee.Math.Core.float4x4"/> to an Array of doubles. The row major order storage of the 
        /// original matrix is kept. This way the returned array can be used in environments taking row major order matrices
        /// (e.g. OpenGL). Use ToArray[]ColOrder for converting the original matrix to environments taking column major order
        /// matrices (like e.g. DirectX).
        /// </summary>
        ...
        public static double[] float4x4ToArrayDoubleRowOrder(Fusee.Math.Core.float4x4 value)
        {
        ...
        /// <param name="value">The matrix value to convert.</param>
        /// <returns>A float array containing 16 values in column major order [m11, m21, m31, ...].</returns>
        public static float[] double4x4ToArrayFloatColOrder(Fusee.Math.Core.double4x4 value)
        {
        ...
        /// <summary>
        /// Converts a <see cref="Fusee.Math.Core.double4x4"/> to an Array of doubles. The row major order storage of the 
        /// original matrix is kept. This way the returned array can be used in environments taking row major order matrices
        /// (e.g. OpenGL). Use ToArray[]ColOrder for converting the original matrix to environments taking column major order
        /// matrices (like e.g. DirectX).
        /// </summary>
        /// <param name="value">The matrix value to convert.</param>
        /// <returns>A double array containing 16 values in row major order [m11, m12, m13, ...].</returns>
        public static double[] double4x4ToArrayDoubleRowOrder(Fusee.Math.Core.double4x4 value)
        {
            return new double[] {value.M11, value.M12, value.M13, value.M14,
                                 value.M21, value.M22, value.M23, value.M24,
                                 value.M31, value.M32, value.M33, value.M34,
        ...
        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.double4x4"/> from an Array of twelve double values in the somewhat awkward Cinema 4D Matrix layout.
        /// This is a 3 rows, 4 columns matrix stored as column vectors with the "offset" vector first (although internally the C4D Matrix arithmetics
        ...
        /// <returns>A newly created <see cref="Fusee.Math.Core.double4x4"/> object</returns>
        public static unsafe Fusee.Math.Core.double4x4 ArrayDoubleC4DLayoutTodouble4x4(double* pValue)
        {
            return new Fusee.Math.Core.double4x4(pValue[3], pValue[6], pValue[9], pValue[0],
        ...
        /// <summary>
        /// Converts a <see cref="Fusee.Math.Core.float3"/> to  a float array.
        /// </summary>
        /// <param name="value">The vector to convert.</param>
        /// <returns>A float array containing three values [x, y, z]</returns>
        public static float[] float3ToArrayFloat(Fusee.Math.Core.float3 value)
        {
            return new float[]{value.x, value.y, value.z};
        }

        /// <summary>
        /// Converts a <see cref="Fusee.Math.Core.float3"/> to  a double array.
        /// </summary>
        /// <param name="value">The vector to convert.</param>
        /// <returns>A double array containing three values [x, y, z]</returns>
        public static double[] float3ToArrayDouble(Fusee.Math.Core.float3 value)
        {
        ...
        /// <summary>
        /// Copys a <see cref="Fusee.Math.Core.float3"/> to an existing float array.
        /// </summary>
        /// <param name="value">The source vector to convert.</param>
        /// <param name="pDst">A pointer to the destination float array [x, y, z]</param>
        public static unsafe void float3ToArrayFloat(Fusee.Math.Core.float3 value, float* pDst)
        {
            pDst[0] = value.x;
            pDst[1] = value.y;
            pDst[2] = value.z;
        ...
        /// <summary>
        /// Copys a <see cref="Fusee.Math.Core.float3"/> to an existing double array.
        /// </summary>
        /// <param name="value">The source vector to convert.</param>
        /// <param name="pDst">A pointer to the destination double array [x, y, z]</param>
        public static unsafe void float3ToArrayDouble(Fusee.Math.Core.float3 value, double* pDst)
        {
            pDst[0] = value.x;
            pDst[1] = value.y;
            pDst[2] = value.z;
        ...
        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.float3"/> from a given float array.
        /// </summary>
        /// <param name="pValue">A float array containing three values [x, y, z]</param>
        /// <returns>The new <see cref="Fusee.Math.Core.float3"/> object</returns>
        public static unsafe Fusee.Math.Core.float3 ArrayFloatTofloat3(float *pValue)
        {
            return new Fusee.Math.Core.float3(pValue[0], pValue[1], pValue[2]);
        }

        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.float3"/> from a given double array.
        /// </summary>
        /// <param name="pValue">A double array containing three values [x, y, z]</param>
        /// <returns>The new <see cref="Fusee.Math.Core.float3"/> object</returns>
        public static unsafe Fusee.Math.Core.float3 ArrayDoubleTofloat3(double* pValue)
        {
            return new Fusee.Math.Core.float3((float)pValue[0], (float)pValue[1], (float)pValue[2]);
        }

        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.double3"/> from a given float array.
        /// </summary>
        /// <param name="pValue">A float array containing three values [x, y, z]</param>
        /// <returns>The new <see cref="Fusee.Math.Core.double3"/> object</returns>
        public static unsafe Fusee.Math.Core.double3 ArrayFloatTodouble3(float* pValue)
        {
            return new Fusee.Math.Core.double3(pValue[0], pValue[1], pValue[2]);
        }

        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.double3"/> from a given double array.
        /// </summary>
        /// <param name="pValue">A double array containing three values [x, y, z]</param>
        /// <returns>The new <see cref="Fusee.Math.Core.double3"/> object</returns>
        public static unsafe Fusee.Math.Core.double3 ArrayDoubleTodouble3(double* pValue)
        {
            return new Fusee.Math.Core.double3(pValue[0], pValue[1], pValue[2]);
        }
        #endregion
        ...
        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.float4"/> from a given float array.
        /// </summary>
        /// <param name="pValue">A float array containing three values [x, y, z]</param>
        /// <returns>The new <see cref="Fusee.Math.Core.float4"/> object</returns>
        public static unsafe Fusee.Math.Core.float4 ArrayFloatTofloat4(float* pValue)
        {
            return new Fusee.Math.Core.float4(pValue[0], pValue[1], pValue[2], pValue[3]);
        }

        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.float4"/> from a given double array.
        /// </summary>
        /// <param name="pValue">A double array containing three values [x, y, z]</param>
        /// <returns>The new <see cref="Fusee.Math.Core.float4"/> object</returns>
        public static unsafe Fusee.Math.Core.float4 ArrayDoubleTofloat4(double* pValue)
        {
            return new Fusee.Math.Core.float4((float)pValue[0], (float)pValue[1], (float)pValue[2], (float)pValue[3]);
        }

        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.double4"/> from a given float array.
        /// </summary>
        /// <param name="pValue">A float array containing three values [x, y, z]</param>
        /// <returns>The new <see cref="Fusee.Math.Core.double4"/> object</returns>
        public static unsafe Fusee.Math.Core.double4 ArrayFloatTodouble4(float* pValue)
        {
            return new Fusee.Math.Core.double4(pValue[0], pValue[1], pValue[2], pValue[3]);
        }

        /// <summary>
        /// Creates a new <see cref="Fusee.Math.Core.double4"/> from a given double array.
        /// </summary>
        /// <param name="pValue">A double array containing three values [x, y, z]</param>
        /// <returns>The new <see cref="Fusee.Math.Core.double4"/> object</returns>
        public static unsafe Fusee.Math.Core.double4 ArrayDoubleTodouble4(double* pValue)
        {
            return new Fusee.Math.Core.double4(pValue[0], pValue[1], pValue[2], pValue[3]);
        }

        /// <summary>
        /// Copys a <see cref="Fusee.Math.Core.float4"/> to an existing float array.
        /// </summary>
        /// <param name="value">The source vector to convert.</param>
        /// <param name="pDst">A pointer to the destination float array [x, y, z]</param>
        public static unsafe void float4ToArrayFloat(Fusee.Math.Core.float4 value, float* pDst)
        {
            pDst[0] = value.x;
            pDst[1] = value.y;
            pDst[2] = value.z;
