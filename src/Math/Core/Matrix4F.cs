...
namespace Fusee.Math.Core
{
	...
	public struct Matrix4F : ISerializable, ICloneable
	{
		...
		/// <returns><see langword="true"/> if <paramref name="obj"/> is a <see cref="Matrix4F"/> and has the same values as this instance; otherwise, <see langword="false"/>.</returns>
        ...
        {
            return Matrix4F.TransformPD(matrix, vector);
        }
