...
namespace Fusee.Structures.Octree
{
    ...
    public class PayloadOctantF<T> : OctantF
    {
        /// <summary>
        ...
        public PayloadOctantF(float3 center, float size, List<T> payload, PayloadOctantD<T>[] children = null)
        {
            Center = center;
            Size = size;
        ...
        /// <param name="size"></param>
        /// <param name="children"></param>        
        public PayloadOctantF(float3 center, float size, PayloadOctantD<T>[] children = null)
        {
            Center = center;
            Size = size;
