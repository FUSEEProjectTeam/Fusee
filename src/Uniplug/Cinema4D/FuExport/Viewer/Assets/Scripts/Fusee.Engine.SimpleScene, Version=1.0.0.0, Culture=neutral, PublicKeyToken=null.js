  ...
  function ContainerExtensions_GetComponent (sncThis, type, inx) {
    ...
    if (!(!((sncThis === null) || 
      ...
      for (var a$0 = sncThis.Components._items, i$0 = 0, l$0 = (sncThis.Components._size | 0); i$0 < l$0; ($temp00 = i$0, 
        ...
        var cont = a$0[i$0];
        var inxC = 0;
        if ($S02().CallVirtual("IsAssignableFrom", null, JSIL.GetType(cont), type)) {
          if (inxC === (inx | 0)) {
            result = cont;
            return result;
          }
...
(function SceneFinderExtensions$Members () {
  ...
  function SceneFinderExtensions_FindComponents$00 (root, match) {
    return (new ($T02())()).__Initialize__({
        _match: match, 
        _rootList: $T03().SingleRootEnum(root)}
    );
  };

  function SceneFinderExtensions_FindComponents$b1$01 (TComponent, root, match) {
    return (new ($asm03.Fusee.Engine.SimpleScene.SceneFinderExtensions_SceneComponentEnumerable$b1.Of(TComponent)) ()).__Initialize__({
        _match: match, 
        _rootList: $T03().SingleRootEnum(root)}
    );
  };
  ...
  function SceneFinderExtensions_FindComponents$02 (rootList, match) {
    return (new ($T02())()).__Initialize__({
        _match: match, 
        _rootList: $IM00().Call(rootList, null)}
    );
  };
  ...
  function SceneFinderExtensions_FindNodes$b1$05 (TNode, root, match) {
    return (new ($asm03.Fusee.Engine.SimpleScene.SceneFinderExtensions_SceneNodeEnumerable$b1.Of(TNode)) ()).__Initialize__({
        _match: match, 
        _rootList: $T03().SingleRootEnum(root)}
    );
  };
  ...
  function SceneFinderExtensions_FindNodesWhereComponent$b1$09 (TComponent, root, match) {
    return (new ($asm03.Fusee.Engine.SimpleScene.SceneFinderExtensions_SceneNodeWhereComponentEnumerable$b2.Of($asm05.Fusee.Serialization.SceneNodeContainer, TComponent)) ()).__Initialize__({
        _match: match, 
        _rootList: $T03().SingleRootEnum(root)}
    );
  };
  ...
  function SceneFinderExtensions_FindNodesWhereComponent$b2$0A (TNode, TComponent, root, match) {
    return (new ($asm03.Fusee.Engine.SimpleScene.SceneFinderExtensions_SceneNodeWhereComponentEnumerable$b2.Of(TNode, TComponent)) ()).__Initialize__({
        _match: match, 
        _rootList: $T03().SingleRootEnum(root)}
    );
  };
...
(function SceneVisitor$Members () {
  ...
  function SceneVisitor_DoVisitComponent (component) {
    ...
    if ((this._visitors.Components).TryGetValue(JSIL.GetType(component), /* ref */ visitComponent)) {
  ...
  function SceneVisitor_DoVisitNode (node) {
    ...
    if ((this._visitors.Nodes).TryGetValue(JSIL.GetType(node), /* ref */ visitNode)) {
          ...
          while (true) {
            if (this._curCompEnumerator !== null) {
              ...
              if (this.SceneVisitor$CurrentNode$value.Children !== null) {
                this.PushState();
                var childEnumerator = $T0B().prototype.GetEnumerator.call(this.SceneVisitor$CurrentNode$value.Children);
  ...
  function SceneVisitor_IsVisitor (methodInfo) {
    var a = methodInfo.GetCustomAttributes($T11().__Type__, false);
  ...
  function SceneVisitor_ScanForVisitors () {
    if (this._visitors === null) {
      ...
      var myType = JSIL.GetType(this);
      if (!$thisType._visitorMap.TryGetValue(myType, /* ref */ new JSIL.MemberReference(this, "_visitors"))) {
        this._visitors = new ($T14())();
        var methods = myType.GetMethods($T16().$Flags("Instance", "NonPublic", "Public"));
        ...
        for (var i = 0; i < (methods.length | 0); i = ((i + 1) | 0)) {
          ...
          if ($thisType.IsVisitor(methodInfo)) {
            ...
            if ((parameters.length | 0) === 1) {
              ...
              if ($S02().CallVirtual("IsAssignableFrom", null, $T01().__Type__, paramType)) {
                (this._visitors.Components).set_Item(paramType, $T1B().MakeComponentVisitor(methodInfo));
              } else if ($S02().CallVirtual("IsAssignableFrom", null, $T00().__Type__, paramType)) {
                (this._visitors.Nodes).set_Item(paramType, $T1B().MakeNodeVistor(methodInfo));
              }
            }
          }
        }
        $thisType._visitorMap.Add(myType, this._visitors);
      }
    }
  };
      ...
      if (((this._visitors.Components).get_Count() | 0) > 0) {
        ...
        try {
          ...
          while ($IM00().Call(enumerator, null)) {
            var node = $IM02().Call(enumerator, null);
        ...
        try {
          ...
          while ($IM00().Call(enumerator, null)) {
            node = $IM02().Call(enumerator, null);
            this.DoTraverseNoComponents(node);
          }
        } finally {
          if (enumerator !== null) {
            $IM04().Call(enumerator, null);
...
(function SceneNodeFinder$b1$Members () {
  ...
  function SceneNodeFinder$b1_MatchNode (node) {
    if (!((this._match === null) || !this._match(node))) {
...
(function SceneComponentFinder$b1$Members () {
  ...
  function SceneComponentFinder$b1_MatchComponent (component) {
    if (!((this._match === null) || !this._match(component))) {
...
(function ViseratorBase$b1$Members () {
  ...
  function ViseratorBase$b1_YieldItem (item) {
    this.SceneVisitor$YieldOnCurrentComponent$value = true;
    $asm09.System.Collections.Generic.Queue$b1.Of($thisType.TItem.get(this)).prototype.Enqueue.call(this._itemQueue, item);
  };
...
(function PickingState$Members () {
  ...
  function PickingState_set_Model (value) {
    (this._model).set_Tos(value);
  };

  function PickingState_set_Projection (value) {
    (this._projection).set_Tos(value);
  };

  function PickingState_set_View (value) {
    (this._view).set_Tos(value);
  };
...
(function AABBCalculator$Members () {
  ...
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm03.Fusee.Engine.SimpleScene.VisitorState)) ();
  };
  var $T04 = function () {
    return ($T04 = JSIL.Memoize($asm04.Fusee.Math.float4x4)) ();
  };
  var $T05 = function () {
    return ($T05 = JSIL.Memoize($asm05.Fusee.Serialization.MeshComponent)) ();
  };
  var $T06 = function () {
    return ($T06 = JSIL.Memoize($asm04.Fusee.Math.AABBf)) ();
  };
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm05.Fusee.Serialization.TransformComponent)) ();
  };
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm03.Fusee.Engine.SimpleScene.ContainerExtensions)) ();
  };
  var $S00 = function () {
  ...
  function AABBCalculator__ctor (sc) {
    this._state = new ($T01())();
  ...
  function AABBCalculator_GetBox () {
    $S00().CallVirtual("Traverse", null, this, this._sc.Children);
    if (this._boxValid) {
  ...
  function AABBCalculator_InitState () {
    ...
    (this._state).Clear();
    (this._state.ModelView = $T04().Identity.MemberwiseClone());
  };

  function AABBCalculator_OnMesh (meshComponent) {
    var box = $T06().op_Multiply((this._state).get_ModelView(), meshComponent.BoundingBox.MemberwiseClone()).MemberwiseClone();
    if (!this._boxValid) {
      this._result = box.MemberwiseClone();
      this._boxValid = true;
    } else {
      this._result = $T06().Union(this._result, box).MemberwiseClone();
    }
  };

  function AABBCalculator_OnTransform (transform) {
    this._state.ModelView = $S01().CallStatic($T04(), "op_Multiply", null, this._state.ModelView.MemberwiseClone(), $T08().Matrix(transform).MemberwiseClone()).MemberwiseClone();
  };
...
(function SceneRenderer$Members () {
  ...
  var $T11 = function () {
    return ($T11 = JSIL.Memoize($asm02.Fusee.Engine.EffectPassDeclaration)) ();
  };
  var $T12 = function () {
    return ($T12 = JSIL.Memoize($asm02.Fusee.Engine.RenderStateSet)) ();
  };
  var $T13 = function () {
    return ($T13 = JSIL.Memoize($asm05.Fusee.Serialization.MeshComponent)) ();
  };
  var $T14 = function () {
    return ($T14 = JSIL.Memoize($asm02.Fusee.Engine.Mesh)) ();
  };
  var $T15 = function () {
    return ($T15 = JSIL.Memoize($asm07.System.Collections.Generic.Dictionary$b2.Of($asm05.Fusee.Serialization.MeshComponent, $asm02.Fusee.Engine.Mesh))) ();
  };
  var $T16 = function () {
    return ($T16 = JSIL.Memoize($asm05.Fusee.Serialization.TransformComponent)) ();
  };
  var $T17 = function () {
    return ($T17 = JSIL.Memoize($asm03.Fusee.Engine.SimpleScene.ContainerExtensions)) ();
  };
  var $T18 = function () {
  ...
  var $T1B = function () {
    return ($T1B = JSIL.Memoize($asm05.Fusee.Serialization.MatChannelContainer)) ();
  };
  var $T1C = function () {
    return ($T1C = JSIL.Memoize($asm05.Fusee.Serialization.SpecularChannelContainer)) ();
  };
  var $S00 = function () {
  ...
  function SceneRenderer_AssembleEffectParamers (mc, scb) {
    ...
    if (mc.get_HasDiffuse()) {
      $S02().CallVirtual("Add", null, effectParameters, (new ($T08())()).__Initialize__({
    ...
    if (!(!mc.get_HasDiffuse() && !mc.get_HasSpecular())) {
      $S02().CallVirtual("Add", null, effectParameters, (new ($T08())()).__Initialize__({
            Name: $T06().get_LightColorName(), 
            Value: $S03().Construct(1, 1, 1)}
        ));
      $S02().CallVirtual("Add", null, effectParameters, (new ($T08())()).__Initialize__({
            Name: $T06().get_LightIntensityName(), 
            Value: 1}
        ));
      $S02().CallVirtual("Add", null, effectParameters, (new ($T08())()).__Initialize__({
            Name: $T06().get_LightDirectionName(), 
  ...
  function SceneRenderer_LoadTexture (path) {
    var texturePath = $T0D().Combine(this._scenePathDirectory, path);
  ...
  function SceneRenderer_MakeMaterial (mc) {
    ...
    return new ($T0F())(JSIL.Array.New($T11(), [(new ($T11())()).__Initialize__({
            VS: scb.get_VS(), 
            PS: scb.get_PS(), 
            StateSet: (new ($T12())()).__Initialize__({
                ZEnable: true, 
  ...
  function SceneRenderer_RenderMesh (meshComponent) {
    ...
    if (!(this._meshMap).TryGetValue(meshComponent, /* ref */ rm)) {
      rm.set($thisType.MakeMesh(meshComponent));
      (this._meshMap).Add(meshComponent, rm.get());
    }
    if (null !== ((this._state).get_Effect()).GetEffectParam($T06().get_LightDirectionName())) {
      this.RenderWithLights(rm.get(), (this._state).get_Effect());
    } else {
      ((this._state).get_Effect()).RenderMesh(rm.get());
    }
  };

  function SceneRenderer_RenderTransform (transform) {
    this._state.Model = $S04().CallStatic($T0B(), "op_Multiply", null, this._state.Model.MemberwiseClone(), $T17().Matrix(transform).MemberwiseClone()).MemberwiseClone();
  ...
  function SceneRenderer_RenderWithLights (rm, effect) {
    ...
    if (((this._lights).get_Count() | 0) > 0) {
      ...
      lightDir.Normalize();
      effect.SetEffectParam($T06().get_LightDirectionName(), lightDir.MemberwiseClone());
  ...
  function SceneRenderer_SetContext (rc) {
    ...
    if (rc !== this._rc) {
      ...
      this._defaultEffect = this.MakeMaterial((new ($T05())()).__Initialize__({
            Diffuse: (new ($T1B())()).__Initialize__({
                Color: $S03().Construct(0.5, 0.5, 0.5)}
            ), 
            Specular: (new ($T1C())()).__Initialize__({
...
(function SceneRendererOld$Members () {
  ...
  var $T17 = function () {
    return ($T17 = JSIL.Memoize($asm05.Fusee.Serialization.MeshComponent)) ();
  };
  var $T18 = function () {
    return ($T18 = JSIL.Memoize($asm03.Fusee.Engine.SimpleScene.ContainerExtensions)) ();
  };
  var $T19 = function () {
    return ($T19 = JSIL.Memoize($asm02.Fusee.Engine.Mesh)) ();
  };
  var $T1A = function () {
    return ($T1A = JSIL.Memoize($asm03.Fusee.Engine.SimpleScene.LightInfo)) ();
  };
  var $T1B = function () {
    return ($T1B = JSIL.Memoize($asm04.Fusee.Math.float4)) ();
  };
  var $T1C = function () {
    return ($T1C = JSIL.Memoize($asm07.System.NotImplementedException)) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.TypeRef("System.Collections.Generic.List`1", [$asm03.TypeRef("Fusee.Engine.SimpleScene.LightInfo")]), null))) ();
  };
    ...
    for (var a$0 = this._sc.Children._items, i$0 = 0, l$0 = (this._sc.Children._size | 0); i$0 < l$0; ($temp00 = i$0, 
      ...
      if (nodeBox !== null) {
        if (ret === null) {
          ...
          ret = $T0D().Union(JSIL.Nullable_Value(ret), JSIL.Nullable_Value(nodeBox)).MemberwiseClone();
        }
      }
    }
    return ret;
  ...
  function SceneRendererOld_MakeMesh (soc) {
    var mc = $T18().GetMesh(soc, 0);
    return (new ($T19())()).__Initialize__({
        Colors: null, 
        Normals: mc.Normals, 
        UVs: mc.UVs, 
        Vertices: mc.Vertices, 
...
JSIL.MakeDelegate("Fusee.Engine.SimpleScene.SceneVisitorHelpers+VisitNodeMethod", false, [], new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.SimpleScene.SceneVisitor"), $asm05.TypeRef("Fusee.Serialization.SceneNodeContainer")]));

/* delegate Fusee.Engine.SimpleScene.SceneVisitorHelpers+VisitComponentMethod */ 

JSIL.MakeDelegate("Fusee.Engine.SimpleScene.SceneVisitorHelpers+VisitComponentMethod", false, [], new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.SimpleScene.SceneVisitor"), $asm05.TypeRef("Fusee.Serialization.SceneComponentContainer")]));
...
(function ViseratorExtensions$Members () {
  ...
  function ViseratorExtensions_Viserate$b2$00 (TViserator, TResult, root) {
    return (new ($asm03.Fusee.Engine.SimpleScene.ViseratorExtensions_ViseratorEnumerable$b2.Of(TViserator, TResult)) ()).__Initialize__({
        _rootList: $T02().SingleRootEnum(root)}
    );
  };
...
(function ViseratorEnumerable$b2$Members () {
  ...
  function ViseratorEnumerable$b2_GetEnumerator () {
    var viserator = JSIL.CloneParameter($thisType.TViserator.get(this), $T00().CreateInstance$b1($thisType.TViserator.get(this))());
    (viserator).Init(this._rootList);
    return $asm07.System.Collections.Generic.IEnumerator$b1.Of($thisType.TResult.get(this)).$Cast(viserator);
  };
