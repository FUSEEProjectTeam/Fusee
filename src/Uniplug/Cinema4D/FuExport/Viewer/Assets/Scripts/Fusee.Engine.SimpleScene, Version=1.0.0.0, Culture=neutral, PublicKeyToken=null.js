...
(function ContainerExtensions$Members () {
  ...
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.TypeRef("System.Collections.Generic.List`1", [$asm05.TypeRef("Fusee.Serialization.SceneComponentContainer")]), []))) ();
  };
  var $S01 = function () {
  ...
  function ContainerExtensions_AddComponent (snc, scc) {
    if ((scc !== null) && (snc !== null)) {
      if (snc.Components === null) {
        snc.Components = $S00().Construct();
      }
      $S01().CallVirtual("Add", null, snc.Components, scc);
    }
  };

  function ContainerExtensions_GetComponent (snc, type, inx) {
    var $temp00;
    if (!(!((snc === null) || 
          (snc.Components === null)) && !$S02().CallStatic($T03(), "op_Equality", null, type, null))) {
      var result = null;
    } else {

      for (var a$0 = snc.Components._items, i$0 = 0, l$0 = snc.Components._size; i$0 < l$0; ($temp00 = i$0, 
          i$0 = ((i$0 + 1) | 0), 
          $temp00)) {
        var cont = a$0[i$0];
        var inxC = 0;
        if ($S03().CallVirtual("IsAssignableFrom", null, JSIL.GetType(cont), type)) {
          if (inxC === inx) {
            result = cont;
            return result;
          }
  ...
  function ContainerExtensions_GetComponent$b1 (TComp, snc, inx) {
    return $thisType.GetComponent(snc, TComp, inx);
  };

  function ContainerExtensions_GetLight (snc, inx) {
    return $T05().$Cast($thisType.GetComponent$b1($T05())(snc, inx));
  };

  function ContainerExtensions_GetMaterial (snc, inx) {
    return $T06().$Cast($thisType.GetComponent$b1($T06())(snc, inx));
  };

  function ContainerExtensions_GetMesh (snc, inx) {
    return $T07().$Cast($thisType.GetComponent$b1($T07())(snc, inx));
  };
...
(function SceneRenderer$Members () {
  ...
  var $T1C = function () {
    return ($T1C = JSIL.Memoize($asm03.Fusee.Engine.SimpleScene.SceneRendererExtensions)) ();
  };
  var $S00 = function () {
  ...
  var $S04 = function () {
    return ($S04 = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.TypeRef("System.Collections.Generic.Dictionary`2", [$asm05.TypeRef("Fusee.Serialization.MeshComponent"), $asm02.TypeRef("Fusee.Engine.Mesh")]), []))) ();
  };
  var $S05 = function () {
    return ($S05 = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.TypeRef("System.Collections.Generic.Dictionary`2", [$asm05.TypeRef("Fusee.Serialization.MaterialComponent"), $asm02.TypeRef("Fusee.Engine.ShaderEffect")]), []))) ();
  };
  var $S06 = function () {
  ...
  function SceneRenderer_VisitNodeAABB (sbc) {
    var $temp00;
    var ret = null;
    var origMV = this._AABBXForm.MemberwiseClone();
    this._AABBXForm = $S08().CallStatic($T0B(), "op_Multiply", null, this._AABBXForm, $T1C().Matrix(sbc.Transform)).MemberwiseClone();
    if (!((sbc === null) || ($T18().GetMesh(sbc, 0) === null))) {
      ret = $T0D().op_Multiply(this._AABBXForm, $T18().GetMesh(sbc, 0).BoundingBox.MemberwiseClone()).MemberwiseClone();
    }
    if (sbc.Children !== null) {

      for (var a$0 = sbc.Children._items, i$0 = 0, l$0 = sbc.Children._size; i$0 < l$0; ($temp00 = i$0, 
          i$0 = ((i$0 + 1) | 0), 
          $temp00)) {
        var child = a$0[i$0];
  ...
  function SceneRenderer_VisitNodeRender (sbc) {
    var $temp00;
    var rm = new JSIL.BoxedVariable(null);
    var origMV = this._rc.get_ModelView().MemberwiseClone();
    var origMat = this.get_CurMat();
    (this._rc.ModelView = $S08().CallStatic($T0B(), "op_Multiply", null, this._rc.ModelView, $T1C().Matrix(sbc.Transform)).MemberwiseClone());
    if (sbc !== null) {
      if ($T18().GetMaterial(sbc, 0) !== null) {
        var mat = this.LookupMaterial($T18().GetMaterial(sbc, 0));
        this.set_CurMat(mat);
      }
      if ($T18().GetMesh(sbc, 0) !== null) {
        if (!this._meshMap.TryGetValue($T18().GetMesh(sbc, 0), /* ref */ rm)) {
          rm.set($thisType.MakeMesh(sbc));
          this._meshMap.Add($T18().GetMesh(sbc, 0), rm.get());
        }
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "VisitNodeRender", 
      new JSIL.MethodSignature(null, [$asm05.TypeRef("Fusee.Serialization.SceneNodeContainer")], []), 
...
(function ShaderCodeBuilder$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "AnalyzeMaterial", 
      new JSIL.MethodSignature(null, [$asm05.TypeRef("Fusee.Serialization.MaterialComponent")], []), 
      ShaderCodeBuilder_AnalyzeMaterial
    );

    $.Method({Static:false, Public:false}, "AnalyzeMesh", 
      new JSIL.MethodSignature(null, [$asm05.TypeRef("Fusee.Serialization.MeshComponent")], []), 
