...
(function SceneComponentContainer$Members () {
  ...
  JSIL.MakeType({
    ...
    .Attribute($asm08.TypeRef("ProtoBuf.ProtoIncludeAttribute"), function () { return [102, $asm05.Fusee.Serialization.MaterialComponent.__Type__]; })
    .Attribute($asm08.TypeRef("ProtoBuf.ProtoContractAttribute"))
    .Attribute($asm08.TypeRef("ProtoBuf.ProtoIncludeAttribute"), function () { return [103, $asm05.Fusee.Serialization.LightComponent.__Type__]; })
    .Attribute($asm08.TypeRef("ProtoBuf.ProtoIncludeAttribute"), function () { return [100, $asm05.Fusee.Serialization.TransformComponent.__Type__]; })
    .Attribute($asm08.TypeRef("ProtoBuf.ProtoIncludeAttribute"), function () { return [101, $asm05.Fusee.Serialization.MeshComponent.__Type__]; });
