...
(function double3$Members () {
  ...
  function double3_TransformNormal$3C (norm, mat) {
    mat.Invert();
    return $thisType.TransformNormalInverse(norm, mat);
  };
  ...
  function double3_TransformPerspective$41 (/* ref */ vec, /* ref */ mat, /* ref */ result) {
    var v = new JSIL.BoxedVariable($S0D().Construct(vec.get()));
...
(function double4x4$Members () {
  ...
  function double4x4_LookAt$21 (eye, target, up) {
    ...
    var y = $T02().Cross(z.MemberwiseClone(), x.MemberwiseClone()).MemberwiseClone();
...
(function float3$Members () {
  ...
  function float3_TransformNormalInverse$40 (norm, invMat) {
    var i = new $thisType();
    i.x = +$thisType.Dot(norm, $S0E().Construct(invMat.Row0));
    i.y = +$thisType.Dot(norm, $S0E().Construct(invMat.Row1));
    i.z = +$thisType.Dot(norm, $S0E().Construct(invMat.Row2));
    return i;
  };
  ...
  function float3_TransformPerspective$43 (/* ref */ vec, /* ref */ mat, /* ref */ result) {
    var v = new JSIL.BoxedVariable($S0F().Construct(vec.get()));
  ...
  function float3_TransformPosition$44 (pos, mat) {
    var p = new $thisType();
    p.x = +$thisType.Dot(pos, $S0E().Construct(mat.get_Column0())) + +mat.Row3.x;
    p.y = +$thisType.Dot(pos, $S0E().Construct(mat.get_Column1())) + +mat.Row3.y;
    p.z = +$thisType.Dot(pos, $S0E().Construct(mat.get_Column2())) + +mat.Row3.z;
    return p;
  };
  ...
  function float3_TransformVector$46 (vec, mat) {
    var v = new $thisType();
    v.x = +$thisType.Dot(vec, $S0E().Construct(mat.get_Column0()));
    v.y = +$thisType.Dot(vec, $S0E().Construct(mat.get_Column1()));
    v.z = +$thisType.Dot(vec, $S0E().Construct(mat.get_Column2()));
    return v;
  };
...
(function float4$Members () {
  ...
  function float4_Transform$3C (/* ref */ vec, /* ref */ quat, /* ref */ result) {
    var i = new JSIL.BoxedVariable(new ($T0B())());
    var t = new JSIL.BoxedVariable(new ($T0B())());
    var v = new JSIL.BoxedVariable($S0D().Construct(vec.get().x, vec.get().y, vec.get().z, vec.get().w));
    $T0B().Invert(/* ref */ quat, /* ref */ i);
    $S0E().CallStatic($T0B(), "Multiply", null, /* ref */ quat, /* ref */ v, /* ref */ t);
    $S0E().CallStatic($T0B(), "Multiply", null, /* ref */ t, /* ref */ i, /* ref */ v);
    result.set($S00().Construct((v.get()).get_x(), (v.get()).get_y(), (v.get()).get_z(), (v.get()).get_w()));
  };
...
(function float4x4$Members () {
  ...
  function float4x4_LookAt$28 (eye, target, up) {
    ...
    var y = $T03().Cross(z.MemberwiseClone(), x.MemberwiseClone()).MemberwiseClone();
...
(function QuaternionD$Members () {
  ...
  function QuaternionD_Normalize$10 () {
    ...
    if (+this.get_Length() > 1.11022302462516E-16) {
      var scale = +((1 / +this.get_Length()));
      (this.xyz = $S03().CallStatic($T00(), "op_Multiply", null, this.xyz.MemberwiseClone(), scale));
...
(function Quaternion$Members () {
  ...
  function Quaternion_EulerToQuaternion (e, inDegrees) {
    if (inDegrees) {
      $T00().prototype._ctor.call(e, 
        $T05().DegreesToRadians(e.x), 
        $T05().DegreesToRadians(e.y), 
        $T05().DegreesToRadians(e.z)
      );
    }
    var sX = Math.fround(Math.sin((+e.x * 0.5)));
    var cX = Math.fround(Math.cos((+e.x * 0.5)));
    var sY = Math.fround(Math.sin((+e.y * 0.5)));
    var cY = Math.fround(Math.cos((+e.y * 0.5)));
    var sZ = Math.fround(Math.sin((+e.z * 0.5)));
    var cZ = Math.fround(Math.cos((+e.z * 0.5)));
  ...
  function Quaternion_Normalize$10 () {
    ...
    if (+this.get_Length() > 1.192093E-07) {
      var scale = +((1 / +this.get_Length()));
      (this.xyz = $S04().CallStatic($T00(), "op_Multiply", null, this.xyz.MemberwiseClone(), scale));
      ($temp00 = +this.get_w() * scale, 
        this.set_w($temp00), 
        $temp00);
    }
  ...
  function Quaternion_QuaternionToEuler (q, inDegrees) {
    ...
    if ($S08().CallStatic($T05(), "Equals", null, test, 1)) {
      ...
      var x = 0;
      var y = 1.57079637;
    } else if ($S08().CallStatic($T05(), "Equals", null, test, -1)) {
      ...
      x = Math.fround(Math.atan2((2 * ((+q.get_y() * +q.get_z()) + (+q.get_w() * +q.get_x()))), (((sqW - sqX) - sqY) + sqZ)));
      y = Math.fround(Math.asin($S09().CallStatic($T05(), "Clamp", null, test, -1, 1)));
      z = Math.fround(Math.atan2((2 * ((+q.get_x() * +q.get_y()) + (+q.get_w() * +q.get_z()))), (((sqW + sqX) - sqY) - sqZ)));
    }
    if (inDegrees) {
  ...
  function Quaternion_ToAxisAngle$19 () {
    ...
    var result = (new ($T09())()).__Initialize__({
        w: (2 * Math.fround(Math.acos(q.get_w())))}
    );
