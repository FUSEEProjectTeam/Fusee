...
JSIL.MakeInterface(
  "Fusee.Engine.IRenderCanvasImp", true, [], function ($) {
    ...
    $.Method({}, "CloseGameWindow", new JSIL.MethodSignature(null, [], []));
...
JSIL.MakeInterface(
  "Fusee.Engine.IRenderContextImp", true, [], function ($) {
    ...
    $.Method({}, "GetPixelColor", new JSIL.MethodSignature($asm0C.TypeRef("System.Drawing.Bitmap"), [
          $.Int32, $.Int32, 
          $.Int32, $.Int32
        ], []));
...
JSIL.MakeInterface(
  "Fusee.Engine.IVideoStreamImp", true, [], function ($) {
    $.Method({}, "GetCurrentFrame", new JSIL.MethodSignature($asm01.TypeRef("Fusee.Engine.ImageData"), [], []));
    $.Method({}, "Start", new JSIL.MethodSignature(null, [], []));
    $.Method({}, "Stop", new JSIL.MethodSignature(null, [], []));
  }, []);
