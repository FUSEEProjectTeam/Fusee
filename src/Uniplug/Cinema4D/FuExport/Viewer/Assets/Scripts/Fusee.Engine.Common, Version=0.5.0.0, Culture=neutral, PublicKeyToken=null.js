...
(function ImageData$Members () {
  ...
  function ImageData_GetPixel (x, y) {
    if (this.PixelFormat === $T01().RGB) {
      var index = ((Math.imul(y, this.Stride) + Math.imul(3, x)) | 0);
      var result = $S00().Construct(this.PixelData, index, true);
    } else {
      index = ((Math.imul(y, this.Stride) + Math.imul(4, x)) | 0);
      result = $S00().Construct(this.PixelData, index, false);
    }
    return result;
  };
