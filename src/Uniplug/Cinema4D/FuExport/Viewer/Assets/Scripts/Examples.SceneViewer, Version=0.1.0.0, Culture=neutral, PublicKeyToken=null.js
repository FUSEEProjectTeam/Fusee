...
(function SceneViewer$Members () {
  ...
  var $T28 = function () {
    return ($T28 = JSIL.Memoize($asm03.Fusee.Engine.SimpleScene.ContainerExtensions)) ();
  };
  var $T29 = function () {
    return ($T29 = JSIL.Memoize($asm05.Fusee.Serialization.SceneHeader)) ();
  };
  var $T2A = function () {
    return ($T2A = JSIL.Memoize($asm07.System.Collections.Generic.List$b1.Of($asm05.Fusee.Serialization.SceneNodeContainer))) ();
  };
  var $S00 = function () {
  ...
  var $S09 = function () {
    return ($S09 = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.TypeRef("System.Collections.Generic.List`1", [$asm05.TypeRef("Fusee.Serialization.SceneNodeContainer")]), [$asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm05.TypeRef("Fusee.Serialization.SceneNodeContainer")])]))) ();
  };
  var $S0A = function () {
  ...
  function SceneViewer_TestSerialize () {
    ...
    $T28().AddComponent(aChild, aMesh);
    var parent = (new ($T15())()).__Initialize__({
        Header: (new ($T29())()).__Initialize__({
            Version: 1, 
            Generator: "Fusee.SceneViewer", 
            CreatedBy: "FuseeProjectTeam"}
        ), 
        Children: $S09().Construct(JSIL.Array.New($T26(), [aChild, aChild]))}
    );
    var ser = new ($T12())();
