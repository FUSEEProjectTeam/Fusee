...
(function SceneViewer$Members () {
  ...
  var $T27 = function () {
    return ($T27 = JSIL.Memoize($asm07.System.Collections.Generic.List$b1.Of($asm05.Fusee.Serialization.SceneComponentContainer))) ();
  };
  var $T28 = function () {
  ...
  var $T2A = function () {
    return ($T2A = JSIL.Memoize($asm05.Fusee.Serialization.SceneHeader)) ();
  };
  var $T2B = function () {
    return ($T2B = JSIL.Memoize($asm07.System.Collections.Generic.List$b1.Of($asm05.Fusee.Serialization.SceneNodeContainer))) ();
  };
  var $S00 = function () {
  ...
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.ConstructorSignature($asm02.TypeRef("Fusee.Engine.GUIHandler"), null))) ();
  };
  var $S04 = function () {
  ...
  var $S05 = function () {
    return ($S05 = JSIL.Memoize(JSIL.MethodSignature.Action($asm02.TypeRef("Fusee.Engine.GUIElement")))) ();
  };
  var $S06 = function () {
    return ($S06 = JSIL.Memoize(new JSIL.ConstructorSignature($asm02.TypeRef("Fusee.Engine.GUIImage"), [
  ...
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.ConstructorSignature($asm02.TypeRef("Fusee.Engine.GUIText"), [
  ...
  var $S09 = function () {
    return ($S09 = JSIL.Memoize(new JSIL.ConstructorSignature($asm04.TypeRef("Fusee.Math.float3"), [
        $asm07.TypeRef("System.Single"), $asm07.TypeRef("System.Single"), 
        $asm07.TypeRef("System.Single")
      ]))) ();
  };
  var $S0A = function () {
    return ($S0A = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.TypeRef("System.Collections.Generic.List`1", [$asm05.TypeRef("Fusee.Serialization.SceneComponentContainer")]), [$asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm05.TypeRef("Fusee.Serialization.SceneComponentContainer")])]))) ();
  };
  var $S0B = function () {
    return ($S0B = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.TypeRef("System.Collections.Generic.List`1", [$asm05.TypeRef("Fusee.Serialization.SceneNodeContainer")]), [$asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm05.TypeRef("Fusee.Serialization.SceneNodeContainer")])]))) ();
  };
  var $S0C = function () {
    return ($S0C = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm07.TypeRef("System.IO.Stream"), $asm07.TypeRef("System.Object")]))) ();
  };
  var $IM00 = function () {
  ...
  function SceneViewer_AdjustModelScaleOffset () {
    ...
    var box = null;
    if (this._scene !== null) {
      box = box2 = ((new ($T06())(this._scene))).GetBox();
      var arg_31_0 = box2 !== null;
    } else {
      arg_31_0 = false;
    }
    if (!arg_31_0) {
    ...
    this._modelScaleOffset = $S01().CallStatic($T08(), "op_Multiply", null, 
      $S02().CallStatic($T08(), "CreateScale", null, +((200 / scale))).MemberwiseClone(), 
  ...
  function SceneViewer_Init () {
    ...
    $S05().CallVirtual("Add", null, this._guiHandler, this._guiFuseeLink);
    this._guiFuseeLogo = $S06().Construct("Assets/FuseeLogo150.png", 10, 10, -5, 150, 80);
    $S05().CallVirtual("Add", null, this._guiHandler, this._guiFuseeLogo);
    this._guiLatoBlack = (this.get_RC()).LoadFont("Assets/Lato-Black.ttf", 14);
    this._guiSubText = $S07().Construct("FUSEE 3D Scene Viewer", this._guiLatoBlack, 100, 100);
    (this._guiSubText.TextColor = $S00().Construct(0.05, 0.25, 0.15, 0.8));
    $S05().CallVirtual("Add", null, this._guiHandler, this._guiSubText);
    var ser = new ($T13())();
    var file = $T15().OpenRead("Assets/Model.fus");
    try {
      this._scene = $T05().$As($S08().CallVirtual("Deserialize", null, ser, file, null, $T05().__Type__));
    } finally {
      if (file !== null) {
        $IM00().Call(file, null);
      }
  ...
  function SceneViewer_RenderAFrame () {
    ...
    if (+$T1D().get_Instance().GetAxis($T20().MouseWheel) === 0) {
      curDamp = Math.fround($T0B().Exp(-0.92000001668930054 * +$T1F().get_Instance().get_DeltaTime()));
    ...
    var mtxRot = $S01().CallStatic($T08(), "op_Multiply", null, 
    ...
    (this.RenderCanvas$RC.ModelView = $S01().CallStatic($T08(), "op_Multiply", null, $S01().CallStatic($T08(), "op_Multiply", null, mtxCam.MemberwiseClone(), mtxRot.MemberwiseClone()).MemberwiseClone(), this._modelScaleOffset.MemberwiseClone()).MemberwiseClone());
  ...
  function SceneViewer_Resize () {
    ...
    (this.RenderCanvas$RC.Projection = $T08().CreatePerspectiveFieldOfView(0.7853982, aspectRatio, 1, 10000).MemberwiseClone());
  ...
  function SceneViewer_TestDeserialize () {
    ...
    try {
      var mc2 = $T05().$As($S08().CallVirtual("Deserialize", null, ser, file, null, $T05().__Type__));
    } finally {
      if (file !== null) {
        $IM00().Call(file, null);
      }
  ...
  function SceneViewer_TestSerialize () {
    var aMesh = (new ($T24())()).__Initialize__({
        Vertices: JSIL.Array.New($T0C(), [$S09().Construct(-1, -1, -1), $S09().Construct(-1, -1, 1), $S09().Construct(-1, 1, -1), $S09().Construct(1, -1, -1), $S09().Construct(1, 1, 1), $S09().Construct(-1, 1, 1), $S09().Construct(1, -1, 1), $S09().Construct(1, 1, -1)]), 
        Normals: JSIL.Array.New($T0C(), [$S09().Construct(-1, -1, -1), $S09().Construct(-1, -1, 1), $S09().Construct(-1, 1, -1), $S09().Construct(1, -1, -1), $S09().Construct(1, 1, 1), $S09().Construct(-1, 1, 1), $S09().Construct(1, -1, 1), $S09().Construct(1, 1, -1)]), 
        Triangles: JSIL.Array.New($T25(), [0, 1, 2, 0, 2, 3, 0, 3, 1, 4, 5, 6, 4, 6, 7, 4, 7, 5])}
    );
    var aChild = (new ($T26())()).__Initialize__({
        Components: $S0A().Construct(JSIL.Array.New($T28(), [(new ($T29())()).__Initialize__({
                Rotation: $S09().Construct(0, 0, 0), 
                Translation: $S09().Construct(0.11, 0.11, 0), 
                Scale: $S09().Construct(1, 1, 1)}
            ), aMesh]))}
    );
    var parent = (new ($T05())()).__Initialize__({
        Header: (new ($T2A())()).__Initialize__({
            Version: 1, 
            Generator: "Fusee.SceneViewer", 
            CreatedBy: "FuseeProjectTeam"}
        ), 
        Children: $S0B().Construct(JSIL.Array.New($T26(), [aChild, aChild]))}
    );
    var ser = new ($T13())();
    var file = $T15().Create("Assets/Test.fus");
    try {
      $S0C().CallVirtual("Serialize", null, ser, file, parent);
    } finally {
      if (file !== null) {
        $IM00().Call(file, null);
      }
