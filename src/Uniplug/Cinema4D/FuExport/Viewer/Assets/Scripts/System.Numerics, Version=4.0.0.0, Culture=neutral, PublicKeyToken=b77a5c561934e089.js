...
var $asm0D = JSIL.DeclareAssembly("System.Numerics, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
...
(function BigInteger$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:false}, "ModPowInner", 
      new JSIL.MethodSignature(null, [
          $.UInt32, $jsilcore.TypeRef("JSIL.Reference", [$asm0D.TypeRef("System.Numerics.BigIntegerBuilder")]), 
          $jsilcore.TypeRef("JSIL.Reference", [$asm0D.TypeRef("System.Numerics.BigIntegerBuilder")]), $jsilcore.TypeRef("JSIL.Reference", [$asm0D.TypeRef("System.Numerics.BigIntegerBuilder")]), 
          $jsilcore.TypeRef("JSIL.Reference", [$asm0D.TypeRef("System.Numerics.BigIntegerBuilder")])
        ], [])
    );
...
(function Complex$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:true }, "op_Explicit", 
      new JSIL.MethodSignature($.Type, [$asm0D.TypeRef("System.Numerics.BigInteger")], [])
    )
      .Attribute($asm0D.TypeRef("__DynamicallyInvokableAttribute"));
...
(function BigIntegerBuilder$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm0D.TypeRef("System.Numerics.BigInteger")], [])
    );

    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm0D.TypeRef("System.Numerics.BigInteger"), $jsilcore.TypeRef("JSIL.Reference", [$.Int32])], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "GetInteger", 
      new JSIL.MethodSignature($asm0D.TypeRef("System.Numerics.BigInteger"), [$.Int32], [])
    );
...
(function BigNumber$Members () {
  ...
  JSIL.MakeStaticClass("System.Numerics.BigNumber", false, [], function ($interfaceBuilder) {
    ...
    $.ExternalMethod({Static:true , Public:false}, "FormatBigInteger", 
      new JSIL.MethodSignature($.String, [
          $asm0D.TypeRef("System.Numerics.BigInteger"), $.String, 
    ...
    $.ExternalMethod({Static:true , Public:false}, "FormatBigIntegerToHexString", 
      new JSIL.MethodSignature($.String, [
          $asm0D.TypeRef("System.Numerics.BigInteger"), $.Char, 
          $.Int32, $asm07.TypeRef("System.Globalization.NumberFormatInfo")
        ], [])
    );

    $.ExternalMethod({Static:true , Public:false}, "HexNumberToBigInteger", 
      new JSIL.MethodSignature($.Boolean, [$jsilcore.TypeRef("JSIL.Reference", [$asm0D.TypeRef("System.Numerics.BigNumber/BigNumberBuffer")]), $jsilcore.TypeRef("JSIL.Reference", [$asm0D.TypeRef("System.Numerics.BigInteger")])], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "ParseBigInteger", 
      new JSIL.MethodSignature($asm0D.TypeRef("System.Numerics.BigInteger"), [
          $.String, $asm07.TypeRef("System.Globalization.NumberStyles"), 
          $asm07.TypeRef("System.Globalization.NumberFormatInfo")
        ], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "TryParseBigInteger", 
      new JSIL.MethodSignature($.Boolean, [
          $.String, $asm07.TypeRef("System.Globalization.NumberStyles"), 
          $asm07.TypeRef("System.Globalization.NumberFormatInfo"), $jsilcore.TypeRef("JSIL.Reference", [$asm0D.TypeRef("System.Numerics.BigInteger")])
        ], [])
    )
      .Attribute($asm07.TypeRef("System.Security.SecuritySafeCriticalAttribute"));
