...
public class BrushBase : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal BrushBase(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(BrushBase obj) {
  ...
  public static BrushBase Alloc() {
    IntPtr cPtr = C4dApiPINVOKE.BrushBase_Alloc();
  ...
  public BrushPixelData GetObjectAt(int x, int y) {
    IntPtr cPtr = C4dApiPINVOKE.BrushBase_GetObjectAt(swigCPtr, x, y);
  ...
  public SWIGTYPE_p_Real CalcSurfaceDistances(PolygonObject pObject, BaseSelect selected, Neighbor pNeighbor, ref Fusee.Math.Core.Vector3D /* Vector*&_cstype */ pNormals, ref Fusee.Math.Core.Vector3D /* Vector*&_cstype */ pGlobalPoints, SWIGTYPE_p_Real pDistance) {
    IntPtr cPtr = C4dApiPINVOKE.BrushBase_CalcSurfaceDistances__SWIG_0(swigCPtr, PolygonObject.getCPtr(pObject), BaseSelect.getCPtr(selected), Neighbor.getCPtr(pNeighbor), ref pNormals /* Vector*&_csin */, ref pGlobalPoints /* Vector*&_csin */, SWIGTYPE_p_Real.getCPtr(pDistance));
  ...
  public SWIGTYPE_p_Real CalcSurfaceDistances(PolygonObject pObject, BaseSelect selected, Neighbor pNeighbor, ref Fusee.Math.Core.Vector3D /* Vector*&_cstype */ pNormals) {
    IntPtr cPtr = C4dApiPINVOKE.BrushBase_CalcSurfaceDistances__SWIG_2(swigCPtr, PolygonObject.getCPtr(pObject), BaseSelect.getCPtr(selected), Neighbor.getCPtr(pNeighbor), ref pNormals /* Vector*&_csin */);
    SWIGTYPE_p_Real ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_Real(cPtr, false);
    return ret;
  }
  ...
  public SWIGTYPE_p_Real CalcSurfaceDistancesFromPoint(PolygonObject pObject, int pindex, Neighbor pNeighbor, ref Fusee.Math.Core.Vector3D /* Vector*&_cstype */ pNormals, ref Fusee.Math.Core.Vector3D /* Vector*&_cstype */ pGlobalPoints) {
    IntPtr cPtr = C4dApiPINVOKE.BrushBase_CalcSurfaceDistancesFromPoint__SWIG_1(swigCPtr, PolygonObject.getCPtr(pObject), pindex, Neighbor.getCPtr(pNeighbor), ref pNormals /* Vector*&_csin */, ref pGlobalPoints /* Vector*&_csin */);
    SWIGTYPE_p_Real ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_Real(cPtr, false);
    return ret;
  }
