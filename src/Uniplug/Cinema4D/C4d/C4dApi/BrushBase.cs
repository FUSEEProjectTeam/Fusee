...
public class BrushBase : global::System.IDisposable {
  ...
  public SWIGTYPE_p_Float CalcSurfaceDistances(PolygonObject pObject, BaseSelect selected, Neighbor pNeighbor, ref Fusee.Math.double3 /* Vector*&_cstype */ pNormals, ref Fusee.Math.double3 /* Vector*&_cstype */ pGlobalPoints, SWIGTYPE_p_Float pDistance) {
  ...
  public SWIGTYPE_p_Float CalcSurfaceDistances(PolygonObject pObject, BaseSelect selected, Neighbor pNeighbor, ref Fusee.Math.double3 /* Vector*&_cstype */ pNormals, ref Fusee.Math.double3 /* Vector*&_cstype */ pGlobalPoints) {
  ...
  public SWIGTYPE_p_Float CalcSurfaceDistances(PolygonObject pObject, BaseSelect selected, Neighbor pNeighbor, ref Fusee.Math.double3 /* Vector*&_cstype */ pNormals) {
  ...
  public SWIGTYPE_p_Float CalcSurfaceDistancesFromPoint(PolygonObject pObject, int pindex, Neighbor pNeighbor, ref Fusee.Math.double3 /* Vector*&_cstype */ pNormals, ref Fusee.Math.double3 /* Vector*&_cstype */ pGlobalPoints, SWIGTYPE_p_Float pDistance) {
  ...
  public SWIGTYPE_p_Float CalcSurfaceDistancesFromPoint(PolygonObject pObject, int pindex, Neighbor pNeighbor, ref Fusee.Math.double3 /* Vector*&_cstype */ pNormals, ref Fusee.Math.double3 /* Vector*&_cstype */ pGlobalPoints) {
  ...
  public SWIGTYPE_p_Float CalcSurfaceDistancesFromPoint(PolygonObject pObject, int pindex, Neighbor pNeighbor, ref Fusee.Math.double3 /* Vector*&_cstype */ pNormals) {
