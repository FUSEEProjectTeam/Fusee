...
public class BaseChannel : C4DAtom {
  ...
  public Fusee.Math.double3 /* Vector_cstype_out */ Sample(SWIGTYPE_p_VolumeData vd, ref Fusee.Math.double3 /* Vector*&_cstype */ p, ref Fusee.Math.double3 /* Vector*&_cstype */ delta, ref Fusee.Math.double3 /* Vector*&_cstype */ n, double t, int tflag, double off, double scale)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseChannel_Sample(swigCPtr, SWIGTYPE_p_VolumeData.getCPtr(vd), ref p /* Vector*&_csin */, ref delta /* Vector*&_csin */, ref n /* Vector*&_csin */, t, tflag, off, scale);
      return ret;
   } /* <Vector_csout> */ 
