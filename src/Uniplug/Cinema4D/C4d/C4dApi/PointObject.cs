...
public class PointObject : BaseObject {
  ...
  public void IncreaseBoundingBox(int cnt, ref Fusee.Math.double3 /* Vector*&_cstype */ v) {
  ...
  public Fusee.Math.double3 /* Vector_cstype_out */ GetPointAt(int inx)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.PointObject_GetPointAt(swigCPtr, inx);
      return ret;
   } /* <Vector_csout> */ 

  public void SetPointAt(int inx, Fusee.Math.double3 /* Vector_cstype */ v) {
