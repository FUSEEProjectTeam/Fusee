...
public class GvPort : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal GvPort(IntPtr cPtr, bool cMemoryOwn) {
  ...
  public bool GetIncomingDestination(ref GvNode /* GvNode_cstype */ node, ref GvPort /* GvPort_cstype */ port) {
    ...
    try {
      bool ret = C4dApiPINVOKE.GvPort_GetIncomingDestination(swigCPtr, (IntPtr) pp_node /* GvNode_csin */, (IntPtr) pp_port /* GvPort_csin */);
  ...
  public bool GetInteger(SWIGTYPE_p_LONG i, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_GetInteger(swigCPtr, SWIGTYPE_p_LONG.getCPtr(i), GvRun.getCPtr(r));
    return ret;
  }
  ...
  public bool GetVector(ref Fusee.Math.Core.Vector3D /* Vector*&_cstype */ v, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_GetVector(swigCPtr, ref v /* Vector*&_csin */, GvRun.getCPtr(r));
    return ret;
  }

  public bool GetNormal(ref Fusee.Math.Core.Vector3D /* Vector*&_cstype */ n, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_GetNormal(swigCPtr, ref n /* Vector*&_csin */, GvRun.getCPtr(r));
    return ret;
  }

  public bool GetMatrix(ref Fusee.Math.Core.Matrix4D /* Matrix*&_cstype */ m, GvRun r) {
    double[] adbl_m;
    unsafe {adbl_m = Fusee.Math.ArrayConversion.Convert.Matrix4DToArrayDoubleC4DLayout(m);    fixed (double *pdbl_m = adbl_m) {
    /* Matrix*&_csin_pre */
    try {
      bool ret = C4dApiPINVOKE.GvPort_GetMatrix(swigCPtr, (IntPtr) pdbl_m /* Matrix*&_csin */, GvRun.getCPtr(r));
      return ret;
    } finally {
  ...
  public bool SetReal(double f, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_SetReal(swigCPtr, f, GvRun.getCPtr(r));
    return ret;
  }

  public bool SetVector(Fusee.Math.Core.Vector3D /* constVector&_cstype */ v, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_SetVector(swigCPtr, ref v /* constVector&_csin */, GvRun.getCPtr(r));
    return ret;
  }

  public bool SetNormal(Fusee.Math.Core.Vector3D /* constVector&_cstype */ n, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_SetNormal(swigCPtr, ref n /* constVector&_csin */, GvRun.getCPtr(r));
    return ret;
  }

  public bool SetMatrix(ref Fusee.Math.Core.Matrix4D /* constMatrix&_cstype */ m, GvRun r) {
    double[] adbl_m;
    unsafe {adbl_m = Fusee.Math.ArrayConversion.Convert.Matrix4DToArrayDoubleC4DLayout(m);    fixed (double *pdbl_m = adbl_m) {
    /* constMatrix&_csin_pre */
    try {
      bool ret = C4dApiPINVOKE.GvPort_SetMatrix(swigCPtr, (IntPtr) pdbl_m /* constMatrix&_csin */, GvRun.getCPtr(r));
      return ret;
    } finally {
  ...
  public bool GetTag(SWIGTYPE_p_p_BaseList2D t, GvRun r, SWIGTYPE_p_LONG index) {
    bool ret = C4dApiPINVOKE.GvPort_GetTag__SWIG_0(swigCPtr, SWIGTYPE_p_p_BaseList2D.getCPtr(t), GvRun.getCPtr(r), SWIGTYPE_p_LONG.getCPtr(index));
    if (C4dApiPINVOKE.SWIGPendingException.Pending) throw C4dApiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool GetInstance(SWIGTYPE_p_p_BaseList2D i, GvRun r, SWIGTYPE_p_LONG index) {
    bool ret = C4dApiPINVOKE.GvPort_GetInstance__SWIG_0(swigCPtr, SWIGTYPE_p_p_BaseList2D.getCPtr(i), GvRun.getCPtr(r), SWIGTYPE_p_LONG.getCPtr(index));
    if (C4dApiPINVOKE.SWIGPendingException.Pending) throw C4dApiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool GetObjectWithIndex(SWIGTYPE_p_p_BaseList2D o, GvRun r, SWIGTYPE_p_LONG index) {
    bool ret = C4dApiPINVOKE.GvPort_GetObjectWithIndex__SWIG_0(swigCPtr, SWIGTYPE_p_p_BaseList2D.getCPtr(o), GvRun.getCPtr(r), SWIGTYPE_p_LONG.getCPtr(index));
    if (C4dApiPINVOKE.SWIGPendingException.Pending) throw C4dApiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public GvDestination GetOutgoing(int index) {
    IntPtr cPtr = C4dApiPINVOKE.GvPort_GetOutgoing(swigCPtr, index);
    GvDestination ret = (cPtr == IntPtr.Zero) ? null : new GvDestination(cPtr, false);
    return ret;
  }
