...
public class GvPort : global::System.IDisposable {
  ...
  public bool GetVector(ref Fusee.Math.double3 /* Vector*&_cstype */ v, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_GetVector(swigCPtr, ref v /* Vector*&_csin */, GvRun.getCPtr(r));
    return ret;
  }

  public bool GetNormal(ref Fusee.Math.double3 /* Vector*&_cstype */ n, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_GetNormal(swigCPtr, ref n /* Vector*&_csin */, GvRun.getCPtr(r));
    return ret;
  }

  public bool GetMatrix(ref Fusee.Math.double4x4 /* Matrix*&_cstype */ m, GvRun r) {
    double[] adbl_m;
  ...
  public bool SetVector(Fusee.Math.double3 /* constVector&_cstype */ v, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_SetVector(swigCPtr, ref v /* constVector&_csin */, GvRun.getCPtr(r));
    return ret;
  }

  public bool SetNormal(Fusee.Math.double3 /* constVector&_cstype */ n, GvRun r) {
    bool ret = C4dApiPINVOKE.GvPort_SetNormal(swigCPtr, ref n /* constVector&_csin */, GvRun.getCPtr(r));
    return ret;
  }

  public bool SetMatrix(ref Fusee.Math.double4x4 /* constMatrix&_cstype */ m, GvRun r) {
    double[] adbl_m;
    unsafe {adbl_m = Fusee.Math.ArrayConvert.double4x4ToArrayDoubleC4DLayout(m);    fixed (double *pdbl_m = adbl_m) {
