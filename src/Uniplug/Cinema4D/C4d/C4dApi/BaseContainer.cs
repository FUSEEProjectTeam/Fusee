...
public class BaseContainer : global::System.IDisposable {
  ...
  public Fusee.Math.double3 /* Vector_cstype_out */ GetVector(int id, Fusee.Math.double3 /* constVector&_cstype */ preset)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseContainer_GetVector__SWIG_0(swigCPtr, id, ref preset /* constVector&_csin */);
      return ret;
   } /* <Vector_csout> */ 

  public Fusee.Math.double3 /* Vector_cstype_out */ GetVector(int id)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseContainer_GetVector__SWIG_1(swigCPtr, id);
      return ret;
   } /* <Vector_csout> */ 

  public Fusee.Math.double4x4 /* Matrix_cstype */ GetMatrix(int id, ref Fusee.Math.double4x4 /* constMatrix&_cstype */ preset) {
    double[] adbl_preset;
  ...
  public Fusee.Math.double4x4 /* Matrix_cstype */ GetMatrix(int id)  {  /* <Matrix_csout> */
  ...
  public BaseContainer GetContainerInstance(int id) {
    global::System.IntPtr cPtr = C4dApiPINVOKE.BaseContainer_GetContainerInstance(swigCPtr, id);
    BaseContainer ret = (cPtr == global::System.IntPtr.Zero) ? null : new BaseContainer(cPtr, false);
    return ret;
  }
  ...
  public void SetVector(int id, Fusee.Math.double3 /* constVector&_cstype */ v) {
    C4dApiPINVOKE.BaseContainer_SetVector(swigCPtr, id, ref v /* constVector&_csin */);
  }

  public void SetMatrix(int id, ref Fusee.Math.double4x4 /* constMatrix&_cstype */ m) {
    double[] adbl_m;
