...
public class GvNodeGUI : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal GvNodeGUI(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(GvNodeGUI obj) {
  ...
  public SWIGTYPE_p_GeUserArea GetUserArea() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeGUI_GetUserArea(swigCPtr);
    SWIGTYPE_p_GeUserArea ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_GeUserArea(cPtr, false);
    return ret;
  }

  public GvNodeMaster GetMaster() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeGUI_GetMaster(swigCPtr);
    GvNodeMaster ret = (cPtr == IntPtr.Zero) ? null : new GvNodeMaster(cPtr, false);
    return ret;
  }

  public SWIGTYPE_p_GeDialog GetDialog() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeGUI_GetDialog(swigCPtr);
    SWIGTYPE_p_GeDialog ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_GeDialog(cPtr, false);
    return ret;
  }
  ...
  public GvNode GetNodeGlobal(int x, int y) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeGUI_GetNodeGlobal(swigCPtr, x, y);
