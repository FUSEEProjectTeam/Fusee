...
public class CAMorphNode : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal CAMorphNode(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(CAMorphNode obj) {
  ...
  public CAMorphNode GetNext() {
    IntPtr cPtr = C4dApiPINVOKE.CAMorphNode_GetNext(swigCPtr);
    CAMorphNode ret = (cPtr == IntPtr.Zero) ? null : new CAMorphNode(cPtr, false);
    return ret;
  }

  public CAMorphNode GetPrev() {
    IntPtr cPtr = C4dApiPINVOKE.CAMorphNode_GetPrev(swigCPtr);
    CAMorphNode ret = (cPtr == IntPtr.Zero) ? null : new CAMorphNode(cPtr, false);
    return ret;
  }

  public CAMorphNode GetUp() {
    IntPtr cPtr = C4dApiPINVOKE.CAMorphNode_GetUp(swigCPtr);
    CAMorphNode ret = (cPtr == IntPtr.Zero) ? null : new CAMorphNode(cPtr, false);
    return ret;
  }

  public CAMorphNode GetDown() {
    IntPtr cPtr = C4dApiPINVOKE.CAMorphNode_GetDown(swigCPtr);
    CAMorphNode ret = (cPtr == IntPtr.Zero) ? null : new CAMorphNode(cPtr, false);
    return ret;
  }
  ...
  public Fusee.Math.Core.Vector3D /* Vector_cstype_out */ GetP()  {  /* <Vector_csout> */
      Fusee.Math.Core.Vector3D ret = C4dApiPINVOKE.CAMorphNode_GetP(swigCPtr);
      return ret;
   } /* <Vector_csout> */ 

  public Fusee.Math.Core.Vector3D /* Vector_cstype_out */ GetS()  {  /* <Vector_csout> */
      Fusee.Math.Core.Vector3D ret = C4dApiPINVOKE.CAMorphNode_GetS(swigCPtr);
      return ret;
   } /* <Vector_csout> */ 

  public Fusee.Math.Core.Vector3D /* Vector_cstype_out */ GetR()  {  /* <Vector_csout> */
      Fusee.Math.Core.Vector3D ret = C4dApiPINVOKE.CAMorphNode_GetR(swigCPtr);
      return ret;
   } /* <Vector_csout> */ 

  public void SetP(Fusee.Math.Core.Vector3D /* constVector&_cstype */ p) {
    C4dApiPINVOKE.CAMorphNode_SetP(swigCPtr, ref p /* constVector&_csin */);
  }

  public void SetS(Fusee.Math.Core.Vector3D /* constVector&_cstype */ s) {
  ...
  public Fusee.Math.Core.Vector3D /* Vector_cstype_out */ GetPoint(int index)  {  /* <Vector_csout> */
      Fusee.Math.Core.Vector3D ret = C4dApiPINVOKE.CAMorphNode_GetPoint(swigCPtr, index);
      return ret;
   } /* <Vector_csout> */ 

  public void SetPoint(int index, Fusee.Math.Core.Vector3D /* constVector&_cstype */ pnt) {
  ...
  public Fusee.Math.Core.Vector3D /* Vector_cstype_out */ GetTangent(int index)  {  /* <Vector_csout> */
      Fusee.Math.Core.Vector3D ret = C4dApiPINVOKE.CAMorphNode_GetTangent(swigCPtr, index);
      return ret;
   } /* <Vector_csout> */ 
  ...
  public void GetUV(int tindex, int index, SWIGTYPE_p_UVWStruct uv) {
    C4dApiPINVOKE.CAMorphNode_GetUV(swigCPtr, tindex, index, SWIGTYPE_p_UVWStruct.getCPtr(uv));
    if (C4dApiPINVOKE.SWIGPendingException.Pending) throw C4dApiPINVOKE.SWIGPendingException.Retrieve();
  }
