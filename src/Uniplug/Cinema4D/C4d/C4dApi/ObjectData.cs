...
public class ObjectData : NodeData {
  ...
  public virtual void GetDimension(BaseObject op, ref Fusee.Math.double3 /* Vector*&_cstype */ mp, ref Fusee.Math.double3 /* Vector*&_cstype */ rad) {
  ...
  public virtual bool MoveHandle(BaseObject op, BaseObject undo, Fusee.Math.double3 /* constVector&_cstype */ mouse_pos, int hit_id, QUALIFIER qualifier, BaseDraw bd) {
  ...
  public virtual void GetModelingAxis(BaseObject op, BaseDocument doc, ref Fusee.Math.double4x4 /* Matrix*&_cstype */ axis) {
    double[] adbl_axis;
  ...
  public virtual bool ModifyObject(BaseObject mod, BaseDocument doc, BaseObject op, ref Fusee.Math.double4x4 /* constMatrix&_cstype */ op_mg, ref Fusee.Math.double4x4 /* constMatrix&_cstype */ mod_mg, double lod, int flags, BaseThread thread) {
    double[] adbl_op_mg;
  ...
  public virtual void SetHandle(BaseObject op, int i, Fusee.Math.double3 /* Vector_cstype */ p, HandleInfo info) {
