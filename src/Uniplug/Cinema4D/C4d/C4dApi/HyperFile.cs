...
public class HyperFile : global::System.IDisposable {
  ...
  public bool ReadVector(ref Fusee.Math.double3 /* Vector*&_cstype */ v) {
  ...
  public bool ReadMatrix(ref Fusee.Math.double4x4 /* Matrix*&_cstype */ v) {
    double[] adbl_v;
  ...
  public bool WriteVector(Fusee.Math.double3 /* constVector&_cstype */ v) {
  ...
  public bool WriteMatrix(ref Fusee.Math.double4x4 /* constMatrix&_cstype */ v) {
    double[] adbl_v;
    unsafe {adbl_v = Fusee.Math.ArrayConvert.double4x4ToArrayDoubleC4DLayout(v);    fixed (double *pdbl_v = adbl_v) {
