...
public class CTrack : global::System.IDisposable {
  ...
  public double GetValue(BaseDocument doc, BaseTime time, int fps) {
    double ret = C4dApiPINVOKE.CTrack_GetValue(swigCPtr, BaseDocument.getCPtr(doc), BaseTime.getCPtr(time), fps);
    if (C4dApiPINVOKE.SWIGPendingException.Pending) throw C4dApiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
