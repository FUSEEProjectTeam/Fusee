...
public class RenderData : BaseList2D {
  ...
  internal RenderData(IntPtr cPtr, bool cMemoryOwn) : base(C4dApiPINVOKE.RenderData_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(RenderData obj) {
  ...
  public new RenderData GetNext() {
    IntPtr cPtr = C4dApiPINVOKE.RenderData_GetNext(swigCPtr);
    RenderData ret = (cPtr == IntPtr.Zero) ? null : new RenderData(cPtr, false);
    return ret;
  }

  public new RenderData GetPred() {
    IntPtr cPtr = C4dApiPINVOKE.RenderData_GetPred(swigCPtr);
    RenderData ret = (cPtr == IntPtr.Zero) ? null : new RenderData(cPtr, false);
    return ret;
  }

  public new RenderData GetDown() {
    IntPtr cPtr = C4dApiPINVOKE.RenderData_GetDown(swigCPtr);
    RenderData ret = (cPtr == IntPtr.Zero) ? null : new RenderData(cPtr, false);
    return ret;
  }

  public new RenderData GetUp() {
    IntPtr cPtr = C4dApiPINVOKE.RenderData_GetUp(swigCPtr);
    RenderData ret = (cPtr == IntPtr.Zero) ? null : new RenderData(cPtr, false);
    return ret;
  }

  public new RenderData GetDownLast() {
    IntPtr cPtr = C4dApiPINVOKE.RenderData_GetDownLast(swigCPtr);
    RenderData ret = (cPtr == IntPtr.Zero) ? null : new RenderData(cPtr, false);
    return ret;
  }

  public SWIGTYPE_p_BaseVideoPost GetFirstVideoPost() {
    IntPtr cPtr = C4dApiPINVOKE.RenderData_GetFirstVideoPost(swigCPtr);
    SWIGTYPE_p_BaseVideoPost ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_BaseVideoPost(cPtr, false);
    return ret;
  }
  ...
  public MultipassObject GetFirstMultipass() {
    IntPtr cPtr = C4dApiPINVOKE.RenderData_GetFirstMultipass(swigCPtr);
  ...
  public static RenderData Alloc() {
    IntPtr cPtr = C4dApiPINVOKE.RenderData_Alloc();
    RenderData ret = (cPtr == IntPtr.Zero) ? null : new RenderData(cPtr, false);
    return ret;
  }
