...
public class BaseSelect : global::System.IDisposable {
  ...
  public bool SelectAll(int min, int max, bool deselectAll) {
    bool ret = C4dApiPINVOKE.BaseSelect_SelectAll__SWIG_0(swigCPtr, min, max, deselectAll);
    return ret;
  }

  public bool SelectAll(int min, int max) {
    bool ret = C4dApiPINVOKE.BaseSelect_SelectAll__SWIG_1(swigCPtr, min, max);
    return ret;
  }
