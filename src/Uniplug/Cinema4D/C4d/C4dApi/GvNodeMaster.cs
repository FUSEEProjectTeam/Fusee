...
public class GvNodeMaster : BaseList2D {
  ...
  internal GvNodeMaster(IntPtr cPtr, bool cMemoryOwn) : base(C4dApiPINVOKE.GvNodeMaster_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public GvNode AllocNode(int id) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_AllocNode(swigCPtr, id);
  ...
  public GvNode CreateNode(GvNode parent, int id, GvNode insert, int x, int y) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_CreateNode__SWIG_0(swigCPtr, GvNode.getCPtr(parent), id, GvNode.getCPtr(insert), x, y);
    GvNode ret = (cPtr == IntPtr.Zero) ? null : new GvNode(cPtr, false);
    return ret;
  }

  public GvNode CreateNode(GvNode parent, int id, GvNode insert, int x) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_CreateNode__SWIG_1(swigCPtr, GvNode.getCPtr(parent), id, GvNode.getCPtr(insert), x);
    GvNode ret = (cPtr == IntPtr.Zero) ? null : new GvNode(cPtr, false);
    return ret;
  }

  public GvNode CreateNode(GvNode parent, int id, GvNode insert) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_CreateNode__SWIG_2(swigCPtr, GvNode.getCPtr(parent), id, GvNode.getCPtr(insert));
    GvNode ret = (cPtr == IntPtr.Zero) ? null : new GvNode(cPtr, false);
    return ret;
  }

  public GvNode CreateNode(GvNode parent, int id) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_CreateNode__SWIG_3(swigCPtr, GvNode.getCPtr(parent), id);
    GvNode ret = (cPtr == IntPtr.Zero) ? null : new GvNode(cPtr, false);
    return ret;
  }

  public GvNode GetRoot() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_GetRoot(swigCPtr);
    GvNode ret = (cPtr == IntPtr.Zero) ? null : new GvNode(cPtr, false);
    return ret;
  }

  public BaseList2D GetOwner() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_GetOwner(swigCPtr);
  ...
  public GvRun GetRun() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_GetRun(swigCPtr);
    GvRun ret = (cPtr == IntPtr.Zero) ? null : new GvRun(cPtr, false);
    return ret;
  }

  public GvCalc GetCalc() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_GetCalc(swigCPtr);
    GvCalc ret = (cPtr == IntPtr.Zero) ? null : new GvCalc(cPtr, false);
    return ret;
  }

  public GvQuery AllocQuery() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_AllocQuery(swigCPtr);
    GvQuery ret = (cPtr == IntPtr.Zero) ? null : new GvQuery(cPtr, false);
    return ret;
  }
  ...
  public GvInit AllocInit() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_AllocInit(swigCPtr);
    GvInit ret = (cPtr == IntPtr.Zero) ? null : new GvInit(cPtr, false);
    return ret;
  }
  ...
  public SWIGTYPE_p_void GetUserData(int id) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_GetUserData(swigCPtr, id);
  ...
  public GvCalcTable AllocCalculationTable(int cpu_count, bool sort, int nr_of_preallocated_entries, bool iteration) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_AllocCalculationTable__SWIG_0(swigCPtr, cpu_count, sort, nr_of_preallocated_entries, iteration);
    GvCalcTable ret = (cPtr == IntPtr.Zero) ? null : new GvCalcTable(cPtr, false);
    return ret;
  }

  public GvCalcTable AllocCalculationTable(int cpu_count, bool sort, int nr_of_preallocated_entries) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_AllocCalculationTable__SWIG_1(swigCPtr, cpu_count, sort, nr_of_preallocated_entries);
    GvCalcTable ret = (cPtr == IntPtr.Zero) ? null : new GvCalcTable(cPtr, false);
    return ret;
  }

  public GvCalcTable AllocCalculationTable(int cpu_count, bool sort) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_AllocCalculationTable__SWIG_2(swigCPtr, cpu_count, sort);
    GvCalcTable ret = (cPtr == IntPtr.Zero) ? null : new GvCalcTable(cPtr, false);
    return ret;
  }

  public GvCalcTable AllocCalculationTable(int cpu_count) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_AllocCalculationTable__SWIG_3(swigCPtr, cpu_count);
    GvCalcTable ret = (cPtr == IntPtr.Zero) ? null : new GvCalcTable(cPtr, false);
    return ret;
  }
  ...
  public SWIGTYPE_p_GvCopyBuffer GetCopyBuffer(GvNode first, bool copy_selected) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_GetCopyBuffer__SWIG_0(swigCPtr, GvNode.getCPtr(first), copy_selected);
    SWIGTYPE_p_GvCopyBuffer ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_GvCopyBuffer(cPtr, false);
    return ret;
  }

  public SWIGTYPE_p_GvCopyBuffer GetCopyBuffer(GvNode first) {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_GetCopyBuffer__SWIG_1(swigCPtr, GvNode.getCPtr(first));
    SWIGTYPE_p_GvCopyBuffer ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_GvCopyBuffer(cPtr, false);
    return ret;
  }

  public SWIGTYPE_p_GvCopyBuffer GetCopyBuffer() {
    IntPtr cPtr = C4dApiPINVOKE.GvNodeMaster_GetCopyBuffer__SWIG_2(swigCPtr);
    SWIGTYPE_p_GvCopyBuffer ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_GvCopyBuffer(cPtr, false);
    return ret;
  }
