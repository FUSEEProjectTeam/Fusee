...
public class BaseShader : BaseList2D {
  ...
  public Fusee.Math.double3 /* Vector_cstype_out */ Sample(ChannelData cd)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseShader_Sample(swigCPtr, ChannelData.getCPtr(cd));
      return ret;
   } /* <Vector_csout> */ 

  public Fusee.Math.double3 /* Vector_cstype_out */ SampleBump(ChannelData cd, SAMPLEBUMP bumpflags)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseShader_SampleBump(swigCPtr, ChannelData.getCPtr(cd), (int)bumpflags);
      return ret;
   } /* <Vector_csout> */ 
