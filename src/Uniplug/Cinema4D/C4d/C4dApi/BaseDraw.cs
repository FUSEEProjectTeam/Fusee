...
public class BaseDraw : BaseView {
  ...
  public void InitView(BaseContainer camera, ref Fusee.Math.double4x4 /* constMatrix&_cstype */ op_m, double sv, double pix_x, double pix_y, bool fitview) {
    double[] adbl_op_m;
  ...
  public Fusee.Math.double3 /* Vector_cstype_out */ GetObjectColor(BaseDrawHelp bh, BaseObject op, bool lines)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseDraw_GetObjectColor__SWIG_0(swigCPtr, BaseDrawHelp.getCPtr(bh), BaseObject.getCPtr(op), lines);
      return ret;
   } /* <Vector_csout> */ 

  public Fusee.Math.double3 /* Vector_cstype_out */ GetObjectColor(BaseDrawHelp bh, BaseObject op)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseDraw_GetObjectColor__SWIG_1(swigCPtr, BaseDrawHelp.getCPtr(bh), BaseObject.getCPtr(op));
      return ret;
   } /* <Vector_csout> */ 

  public Fusee.Math.double3 /* Vector_cstype_out */ CheckColor(Fusee.Math.double3 /* constVector&_cstype */ col)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseDraw_CheckColor(swigCPtr, ref col /* constVector&_csin */);
      return ret;
   } /* <Vector_csout> */ 
  ...
  public void SetPen(Fusee.Math.double3 /* constVector&_cstype */ col, int flags) {
    C4dApiPINVOKE.BaseDraw_SetPen__SWIG_0(swigCPtr, ref col /* constVector&_csin */, flags);
  }

  public void SetPen(Fusee.Math.double3 /* constVector&_cstype */ col) {
  ...
  public Fusee.Math.double3 /* Vector_cstype_out */ ConvertColor(Fusee.Math.double3 /* constVector&_cstype */ c)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseDraw_ConvertColor(swigCPtr, ref c /* constVector&_csin */);
      return ret;
   } /* <Vector_csout> */ 

  public Fusee.Math.double3 /* Vector_cstype_out */ ConvertColorReverse(Fusee.Math.double3 /* constVector&_cstype */ c)  {  /* <Vector_csout> */
      Fusee.Math.double3 ret = C4dApiPINVOKE.BaseDraw_ConvertColorReverse(swigCPtr, ref c /* constVector&_csin */);
      return ret;
   } /* <Vector_csout> */ 
  ...
  public void SetMatrix_Matrix(BaseObject op, ref Fusee.Math.double4x4 /* constMatrix&_cstype */ mg) {
    double[] adbl_mg;
  ...
  public void SetMatrix_Matrix(BaseObject op, ref Fusee.Math.double4x4 /* constMatrix&_cstype */ mg, int zoffset) {
    double[] adbl_mg;
    unsafe {adbl_mg = Fusee.Math.ArrayConvert.double4x4ToArrayDoubleC4DLayout(mg);    fixed (double *pdbl_mg = adbl_mg) {
    /* constMatrix&_csin_pre */
    try {
  ...
  public void DrawPoint2D(Fusee.Math.double3 /* constVector&_cstype */ p) {
    C4dApiPINVOKE.BaseDraw_DrawPoint2D(swigCPtr, ref p /* constVector&_csin */);
  }

  public void DrawLine2D(Fusee.Math.double3 /* constVector&_cstype */ p1, Fusee.Math.double3 /* constVector&_cstype */ p2) {
    C4dApiPINVOKE.BaseDraw_DrawLine2D(swigCPtr, ref p1 /* constVector&_csin */, ref p2 /* constVector&_csin */);
  }

  public void DrawHandle2D(Fusee.Math.double3 /* constVector&_cstype */ p, DRAWHANDLE type) {
    C4dApiPINVOKE.BaseDraw_DrawHandle2D__SWIG_0(swigCPtr, ref p /* constVector&_csin */, (int)type);
  }

  public void DrawHandle2D(Fusee.Math.double3 /* constVector&_cstype */ p) {
  ...
  public void DrawHandle(Fusee.Math.double3 /* constVector&_cstype */ vp, DRAWHANDLE type, int flags) {
  ...
  public void DrawLine(Fusee.Math.double3 /* constVector&_cstype */ p1, Fusee.Math.double3 /* constVector&_cstype */ p2, int flags) {
    C4dApiPINVOKE.BaseDraw_DrawLine(swigCPtr, ref p1 /* constVector&_csin */, ref p2 /* constVector&_csin */, flags);
  }

  public void DrawArc(Fusee.Math.double3 /* constVector&_cstype */ pos, double radius, double angle_start, double angle_end, int subdiv, int flags) {
    C4dApiPINVOKE.BaseDraw_DrawArc__SWIG_0(swigCPtr, ref pos /* constVector&_csin */, radius, angle_start, angle_end, subdiv, flags);
  }

  public void DrawArc(Fusee.Math.double3 /* constVector&_cstype */ pos, double radius, double angle_start, double angle_end, int subdiv) {
    C4dApiPINVOKE.BaseDraw_DrawArc__SWIG_1(swigCPtr, ref pos /* constVector&_csin */, radius, angle_start, angle_end, subdiv);
  }

  public void DrawArc(Fusee.Math.double3 /* constVector&_cstype */ pos, double radius, double angle_start, double angle_end) {
    C4dApiPINVOKE.BaseDraw_DrawArc__SWIG_2(swigCPtr, ref pos /* constVector&_csin */, radius, angle_start, angle_end);
  }

  public void DrawPoly(ref Fusee.Math.double3 /* Vector*&_cstype */ vp, ref Fusee.Math.double3 /* Vector*&_cstype */ vf, ref Fusee.Math.double3 /* Vector*&_cstype */ vn, int anz, int flags) {
    C4dApiPINVOKE.BaseDraw_DrawPoly(swigCPtr, ref vp /* Vector*&_csin */, ref vf /* Vector*&_csin */, ref vn /* Vector*&_csin */, anz, flags);
  }

  public void DrawTexture(BaseBitmap bmp, ref Fusee.Math.double3 /* Vector*&_cstype */ padr4, ref Fusee.Math.double3 /* Vector*&_cstype */ cadr, ref Fusee.Math.double3 /* Vector*&_cstype */ vnadr, ref Fusee.Math.double3 /* Vector*&_cstype */ uvadr, int pntcnt, DRAW_ALPHA alphamode, DRAW_TEXTUREFLAGS flags) {
  ...
  public void DrawTexture(SWIGTYPE_p_C4DGLuint bmp, ref Fusee.Math.double3 /* Vector*&_cstype */ padr4, ref Fusee.Math.double3 /* Vector*&_cstype */ cadr, ref Fusee.Math.double3 /* Vector*&_cstype */ vnadr, ref Fusee.Math.double3 /* Vector*&_cstype */ uvadr, int pntcnt, DRAW_ALPHA alphamode) {
  ...
  public void DrawCircle(ref Fusee.Math.double4x4 /* constMatrix&_cstype */ m) {
    double[] adbl_m;
  ...
  public void DrawBox(ref Fusee.Math.double4x4 /* constMatrix&_cstype */ m, double size, Fusee.Math.double3 /* constVector&_cstype */ col, bool wire) {
    double[] adbl_m;
    unsafe {adbl_m = Fusee.Math.ArrayConvert.double4x4ToArrayDoubleC4DLayout(m);    fixed (double *pdbl_m = adbl_m) {
    /* constMatrix&_csin_pre */
    try {
  ...
  public void DrawPolygon(ref Fusee.Math.double3 /* Vector*&_cstype */ p, ref Fusee.Math.double3 /* Vector*&_cstype */ f, bool quad) {
    C4dApiPINVOKE.BaseDraw_DrawPolygon(swigCPtr, ref p /* Vector*&_csin */, ref f /* Vector*&_csin */, quad);
  }

  public void DrawSphere(Fusee.Math.double3 /* constVector&_cstype */ off, Fusee.Math.double3 /* constVector&_cstype */ size, Fusee.Math.double3 /* constVector&_cstype */ col, int flags) {
  ...
  public DRAWRESULT DrawPolygonObject(BaseDrawHelp bh, BaseObject op, DRAWOBJECT flags, BaseObject parent, Fusee.Math.double3 /* constVector&_cstype */ col) {
  ...
  public DRAWRESULT DrawObject(BaseDrawHelp bh, BaseObject op, DRAWOBJECT flags, DRAWPASS drawpass, BaseObject parent, Fusee.Math.double3 /* constVector&_cstype */ col) {
  ...
  public void LineStrip(Fusee.Math.double3 /* constVector&_cstype */ vp, Fusee.Math.double3 /* constVector&_cstype */ vc, int flags) {
  ...
  public bool GetHighlightPassColor(BaseDrawHelp bh, bool lineObject, ref Fusee.Math.double3 /* Vector*&_cstype */ col) {
  ...
  public bool PointInRange(Fusee.Math.double3 /* constVector&_cstype */ p, int x, int y) {
  ...
  public double SimpleShade(Fusee.Math.double3 /* constVector&_cstype */ p, Fusee.Math.double3 /* constVector&_cstype */ n) {
