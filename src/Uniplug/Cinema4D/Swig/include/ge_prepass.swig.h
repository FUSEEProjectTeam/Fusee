...
enum MPBTYPE
{
	...
	MPBTYPE_PERCENT					= 1002,	// Real, get, set
	MPBTYPE_BLENDMODE				= 1003,	// LONG, get, set
	MPBTYPE_COLORMODE				= 1004,	// LONG, get, set
	MPBTYPE_BITMAPTYPE			= 1005,	// LONG, get
	MPBTYPE_NAME						= 1006,	// String, get, set
	MPBTYPE_DPI							= 1007,	// LONG, get, set
	MPBTYPE_USERID					= 1008,	// LONG, get, set
	MPBTYPE_USERSUBID				= 1009,	// LONG, get, set
	MPBTYPE_FORCEBLEND			= 1010	// LONG, get, set		(special mode used to force blend layers)
...
enum NBIT
{
	...
	// definees if the tracks of the object are shown
	NBIT_TL1_FOLDTR	 			= 18,
	NBIT_TL2_FOLDTR	 			= 19,
	NBIT_TL3_FOLDTR	 			= 20,
	NBIT_TL4_FOLDTR	 			= 21,
...
#define WPREF_OPENGL_TEXTURE_FILTERING				1025 // LONG
...
enum DRAW_ALPHA
{
	...
	DRAW_ALPHA_FROM_IMAGE	= 13 // generates the alpha channel from the image information, if no alpha channel exists
...
enum VOLUMEINFO
{
	...
	// TODO VOLUMEINFO_INITCALCULATION		= 0x80000000  // shader needs initcalculation call
