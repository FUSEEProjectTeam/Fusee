...
namespace Fusee.Engine.GUI
{
    ...
    public delegate void GUIButtonHandler(GUIButton_Legacy sender, GUIButtonEventArgs ea);
    ...
    public sealed class GUIButton_Legacy : GUIElement
    {
        ...
        public GUIButton_Legacy(int x, int y, int width, int height)
        ...
        /// <param name="width">The width.</param>
        /// <param name="height">The height.</param>
        public GUIButton_Legacy(string text, FontMap fontMap, int x, int y, int width, int height)
