...
namespace Examples.LightTypeTest
{
    public class LightTypeTest : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            DirectionalLight direct = new DirectionalLight(new float3(1, 1, 1), new float4(0.7f, 0.7f, 0.7f, 1), new float4(0.3f, 0.3f, 0.3f, 1), new float4(0.9f, 0.9f, 0.9f, 1), new float3(0, 0, 0), 2);
            PointLight point = new PointLight(new float3(0, 0, 0), new float4(0.7f, 0.7f, 0.7f, 1), new float4(0.1f, 0.1f, 0.1f, 1), new float4(0.9f, 0.9f, 0.9f, 1), 1);
