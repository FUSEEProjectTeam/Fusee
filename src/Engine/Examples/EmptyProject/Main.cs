...
namespace Examples.LightTypeTest
{
    public class LightTypeTest : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            //Sphere
            _object = new SceneEntity("Sphere1", new ActionCode(), _emptySphere, new SpecularMaterial(MoreShaders.GetShader("specular", RC), "Assets/wall.jpg"), new Renderer(sphere));
            ...
            //Cube
            _object = new SceneEntity("Cube1", new ActionCode(), _emptyCube, new SpecularMaterial(MoreShaders.GetShader("specular", RC), "Assets/wall.jpg"), new Renderer(cube));
