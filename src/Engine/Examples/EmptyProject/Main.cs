...
namespace Examples.LightTypeTest
{
    public class LightTypeTest : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            PointLight point = new PointLight(new float3(0, 0, 0), new float4(0.7f, 0.7f, 0.7f, 1), new float4(0.2f, 0.2f, 0.2f, 1), new float4(0.9f, 0.9f, 0.9f, 1), 1);
            SpotLight spot = new SpotLight(new float3(1,1,1), new float3(1, 1, 1), new float4(0.7f, 0.7f, 0.7f, 1), new float4(0.3f, 0.3f, 0.3f, 1), new float4(0.1f, 0.1f, 0.1f, 1), 2);
            ...
            //Cube
            _object = new SceneEntity("Cube1", new ActionCode(), _emptyCube, new BumpMaterial(MoreShaders.GetShader("bump", RC), "Assets/spiegel1.jpg", "Assets/normal2.jpg"), new Renderer(cube));
