...
*/
        ...
        public override void Init()
        {
            ...
            SceneEntity _planet;
            // Lights
            DirectionalLight direct = new DirectionalLight(new float3(0,0,0), new float4(1,1,0,1), new float4(1,1,1,1), new float4(0.7f,0.5f,0.5f,1f), new float3(0,0,0), 0);
...
*/
            // Setup Space Box
            SceneEntity _spaceBox = new SceneEntity("Spacebox", new PlanetMaterial(MoreShaders.GetShader("texture", RC), "Assets/spaceboxTexture.png"), new Renderer(spacebox));
