...
namespace Examples.RocketGame
{
    ...
    public class GameWorld
    {
        ...
        public GameWorld(RenderContext rc)
        {
            ...
            _furniture.Add(new GameEntity("Assets/rocket3.obj.model", rc, -1900, 0, -5000));
            ...
            _furniture.Add(new GameEntity("Assets/chair.obj.model", rc, 1600, 0, -4100, 0, 2.6f));
            ...
            _furniture.Add(new GameEntity("Assets/desk.obj.model", rc, 1500, 0, -4950));
            ...
            _furniture.Add(new GameEntity("Assets/bed.obj.model", rc, 1800, 0, 800));
            ...
            _furniture.Add(new GameEntity("Assets/drawer.obj.model", rc, -700, 0, 1850, 0, (float) Math.PI));
            ...
            _furniture.Add(new GameEntity("Assets/book.obj.model", rc, 500, 1030, -4950,0,1));
