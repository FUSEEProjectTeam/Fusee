...
namespace SceneManagement
{
    public class Program : RenderCanvas
    {
        ...
        private float3 _speed = new float3(3,0,0);
        ...
        public override void Init()
        {
            ...
            _transform.LocalPosition = new float3(100,20,30);
        ...
        public override void RenderAFrame()
        {
            ...
            _transform.LocalPosition += _speed*_direction;
            if (_transform.LocalPosition.x > 200 || _transform.LocalPosition.x < -200)
            {
                _direction *= -1;
            }


            RC.ModelView = _transform.Matrix * float4x4.CreateTranslation(-100, 0, 0) * mtxCam;
