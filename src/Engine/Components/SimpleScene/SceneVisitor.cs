...
namespace Fusee.Engine.SimpleScene
{
    ...
    public class SceneVisitor
    {
        ...
        {
            public Dictionary<Type, SceneVisitorHelpers.VisitNodeMethod> Nodes = new Dictionary<Type, SceneVisitorHelpers.VisitNodeMethod>();
            public Dictionary<Type, SceneVisitorHelpers.VisitComponentMethod> Components = new Dictionary<Type, SceneVisitorHelpers.VisitComponentMethod>();
        }
        ...
        */
        ...
        /// <summary>
        /// Method is called when traversal starts to initialize the traversal state. Override this method in derived classes to initialize any state beyond 
        ...
        /// <summary>
        /// Method is called when going down one hierarchy level while traversing. Pushes the traversal state stack <see cref="State"/>. 
        /// Most visitors will simply initialize the <see cref="State"/> and will thus NOT need to override this method. Make sure to call the base 
        /// implementation in overridden versions.
        /// </summary>
        ...
        /// <summary>
        /// Method is called when going up one hierarchy level while traversing. Pops the traversal state stack <see cref="State"/>. 
        /// Most visitors will simply initialize the <see cref="State"/> and will thus NOT need to override this method. Make sure to call the base 
        /// implementation in overridden versions.
        /// </summary>
