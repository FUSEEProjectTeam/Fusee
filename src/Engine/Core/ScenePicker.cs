...
public class ScenePicker : Viserator<PickResult, ScenePicker.PickerState, SceneNode, SceneComponent>
{
    ...
    /// <summary>
    /// Set the current camera, update View & Projection matrices
    /// </summary>
    ...
    public void UpdateCamera(Camera cam)
    {
        ...
        CurrentCamera = cam;
        View = CurrentNode.GetComponent<Transform>().Matrix;
        var viewport = cam.Viewport;
        Projection = cam.GetProjectionMat((int)viewport.z, (int)viewport.w, out var _);
