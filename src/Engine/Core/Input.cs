...
namespace Fusee.Engine.Core
{
    ...
    public class Input
    {
        ...
        private void OnNewDeviceImpConnected(object sender, NewDeviceImpConnectedArgs args)
        {
            ...
            if (!(sender is IInputDriverImp driver)) throw new InvalidOperationException("Device connecting from unknown driver " + sender.ToString());
        ...
        {
            if (sender == null) throw new ArgumentNullException(nameof(sender));
            if (!(sender is IInputDriverImp driver)) throw new InvalidOperationException("Device disconnecting from unknown driver " + sender.ToString());
