...
namespace Fusee.Engine.Core
{
    ...
    public class WritableArrayTexture : IWritableArrayTexture
    {
        ...
        public WritableArrayTexture(int layers, RenderTargetTextureTypes texType, ImagePixelFormat colorFormat, int width, int height, bool generateMipMaps = true, TextureFilterMode filterMode = TextureFilterMode.LINEAR, TextureWrapMode wrapMode = TextureWrapMode.REPEAT, TextureCompareMode compareMode = TextureCompareMode.NONE, Compare compareFunc = Compare.Less)
        {
