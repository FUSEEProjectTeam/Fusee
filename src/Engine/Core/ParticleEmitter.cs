 ...
 */
        ...
        public void Tick(double deltaTime)
        {
            ...
            if (ParticleMesh == null) ParticleMesh = new(vertices.Length, triangles.Length);
            ParticleMesh.ReplaceVertices(vertices);
            ParticleMesh.ReplaceTriangles(triangles);
            ParticleMesh.ReplaceNormals(normals);
            ParticleMesh.ReplaceUVs(uVs);
