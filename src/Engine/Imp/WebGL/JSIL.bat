...
echo -----------------------------------------------------------------------
echo JJSIL Cross compiling Engine.Simple.exe and referenced DLLs
echo %JSIL_DIR%\bin\JSILc.exe -o="%1..\Web" %1Engine.Simple.exe
%JSIL_DIR%\bin\JSILc.exe -o="%1..\Web" %1Engine.Simple.exe
