...
JSIL.MakeClass($asm01.TypeRef("System.Object"), "Fusee.Engine.RenderContextImp", true, [], function ($) {
    ...
    new JSIL.MethodSignature($asm01.TypeRef("Fusee.Math.float4"), []),
    function get_ClearColor() {
        var ret = this.gl.getParameter(this.gl.COLOR_CLEAR_VALUE);
        return new $asm01.Fusee.Math.float4(ret[0], ret[1], ret[2], ret[3]);
    }
  );

    $.Method({ Static: false, Public: true }, "set_ClearColor",
    new JSIL.MethodSignature(null, [$asm01.TypeRef("Fusee.Math.float4")]),
    ...
    new JSIL.MethodSignature(null, [$asm44.TypeRef("Fusee.Engine.IShaderParam"), $asm00.TypeRef("Fusee.Math.float2")]),
    ...
    new JSIL.MethodSignature(null, [$asm44.TypeRef("Fusee.Engine.IShaderParam"), $asm00.TypeRef("Fusee.Math.float3")]),
    ...
    new JSIL.MethodSignature(null, [$asm44.TypeRef("Fusee.Engine.IShaderParam"), $asm00.TypeRef("Fusee.Math.float4x4")]),
    ...
    new JSIL.MethodSignature(null, [$asm44.TypeRef("Fusee.Engine.IMeshImp"), $jsilcore.TypeRef("System.Array", [$asm00.TypeRef("Fusee.Math.float3")])]),
