...
namespace Fusee.Engine.Imp.Graphics.SilkDesktop
{
    ...
    public class RenderCanvasImp : RenderCanvasImpBase, IRenderCanvasImp, IDisposable
    {
        ...
        public int Width
        {
            ...
            set
            {
                _gameWindow.window.Size = new Vector2D<int>(value, _gameWindow.window.Size.Y);
                BaseWidth = value;
                ResizeWindow();
            }
        }
        ...
        public int Height
        {
            ...
            set
            {
                _gameWindow.window.Size = new Vector2D<int>(_gameWindow.window.Size.X, value);
                BaseHeight = value;
                ResizeWindow();
            }
        }
        ...
        public SixLabors.ImageSharp.Image ShootCurrentFrame(int width, int height)
        {
            ...
            _gameWindow.GL.ReadPixels(0, 0, (uint)Width, (uint)Height, GLEnum.Bgra, GLEnum.UnsignedByte, new Span<byte>(mem));
    ...
    public class RenderCanvasGameWindow : IDisposable
    {
        ...
        protected void OnResize(Vector2D<int> v)
        {
