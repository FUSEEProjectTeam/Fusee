...
{
    public class LibPaintingView : AndroidGameView
    {
        int viewportWidth, viewportHeight;
        int program;
        float[] vertices;

        public LibPaintingView(Context context, IAttributeSet attrs) :
            base(context, attrs)
        {
            Init();
        }

        public LibPaintingView(IntPtr handle, global::Android.Runtime.JniHandleOwnership transfer)
