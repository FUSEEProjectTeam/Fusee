...
namespace Fusee.Engine.Common
{
    ...
    public class MaterialPBR : Material, IEquatable<MaterialPBR>
    {
        /// <summary>
        ...
        /// </returns>
        public static bool operator ==(MaterialPBR lhs, MaterialPBR rhs)
        {
        ...
        /// </returns>
        public bool Equals(MaterialPBR other)
        {
            if (other == null)
                return false;
