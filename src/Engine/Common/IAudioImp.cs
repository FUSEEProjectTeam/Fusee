namespace Fusee.Engine.Common
{
    ...
    public interface IAudioImp
    {
        ...
        /// <summary>
        /// Implementation Tasks: Opens the device. All <see cref="IAudioStreamImp" /> derivate instances have to be wiped and the global volume of a Listener(if 3D Sound is intended) can be set to maximum.
        /// </summary>
        void OpenDevice();
        ...
        /// <returns>A derivate of <see cref="IAudioStreamImp" /> should be returned upon successful file path resolution.</returns>
        IAudioStreamImp LoadFile(string fileName, bool streaming);

        /// <summary>
        /// Implementation Tasks: Stops all <see cref="IAudioStreamImp" /> derived playbacks that this instance is responsible for.
        /// </summary>
        void Stop();

        /// <summary>
        /// Implementation Tasks: Sets the global volume of the application. In 3D Sound usually a Listener is used to accomplish this task. 
        /// In 2D Sound a simple iteration through all <see cref="IAudioStreamImp" /> derived that this instance is responsible for is sufficient.
        /// </summary>
        ...
        /// In 2D Sound an internal master volume property can be implemented that handles all <see cref="IAudioStreamImp" /> derived volumes that this instance is responsible for.
        /// </summary>
        /// <returns>A number in float precision.</returns>
        float GetVolume();

        /// <summary>
        /// Implementation Tasks: Sets the panning for all <see cref="IAudioStreamImp" /> derived that this instance is responsible for.
        /// </summary>
