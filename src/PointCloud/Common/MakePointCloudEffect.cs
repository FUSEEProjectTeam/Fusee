...
namespace Fusee.PointCloud.Common
{
    ...
    public static class MakePointCloudEffect
    {
        ...
        /// <param name="edlNeigbourPx">Number of pixels, used in the EDL lighting calculation.</param>
        /// <returns></returns>
        public static SurfaceEffectPointCloud ForColorPassInstanced(int size, PointColorMode colorMode, PointSizeMode pointSizeMode, PointShape shape, float edlStrength, int edlNeigbourPx)
        {
