...
namespace Fusee.PointCloud.Core
{
    ...
    /// </summary>
    public class PosD3LblBAccessor : PointAccessor<Common.PosD3LblB>
    {
        ...
        public override void SetLabelUInt_8(ref Common.PosD3LblB point, byte val)
        {
            point.Label = val;
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="point">The point cloud point.</param>
        public override ref byte GetLabelUInt_8(ref Common.PosD3LblB point)
        {
        ...
        public override void SetPositionFloat3_64(ref Common.PosD3LblB point, double3 val)
        {
            point.Position = val;
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="point">The point cloud point.</param>
        public override ref double3 GetPositionFloat3_64(ref Common.PosD3LblB point)
        {
