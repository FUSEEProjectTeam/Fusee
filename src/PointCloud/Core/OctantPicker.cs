...
namespace Fusee.PointCloud.Core
{
    ...
    {
        private readonly PointCloudOctant _octant;
        ...
        /// </summary>
        /// <param name="octant">The potree reader.</param>
        ...
        public OctantPicker(PointCloudOctant octant, RenderContext rc, Camera cam, Transform camTransform)
        {
            _octant = octant;
            _rc = rc;
            _cam = cam;
        ...
        public PointCloudOctant? PickDensenstOctant(float2 pickPosClip, int2 viewportSize)
        {
        ...
        public SceneNode CreateCubeFromNode(PointCloudOctant node)
        {
