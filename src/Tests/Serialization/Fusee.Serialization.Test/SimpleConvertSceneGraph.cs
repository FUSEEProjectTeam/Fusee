    ...
    public class SimpleConvertSceneGraphV1
    {
        ...
        public void V1_SimpleScene_Convert()
        {
            ...
            for (var i = 0; i < sceneFileFlattenedAgain.Count; i++)
            {
                ...
                //TODO: will not work because we need to assert "ColorInput.Albedo" or "TextureInput.NormalTexture" and not UniformNameDeclarations.NormalMap....
                if (gtComp is DefaultSurfaceEffect fx)
                {
                    if (fx.LightingSetup.HasFlag(LightingSetupFlags.BlinnPhong))
                    {
        ...
        public static FusFile BuildGroundTruthFusScene()
        {
