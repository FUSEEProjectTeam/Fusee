...
namespace Fusee.Examples.PointcloudEditor.Core
{
    [FuseeApplication(Name = "FUSEE PointcloudEditor Example", Description = "A very simple example.")]
    public class PointcloudEditor : RenderCanvas
    {
        // angle variables
        ...
        private async Task Load()
        {
            ...
            _gui = await FuseeGuiHelper.CreateDefaultGuiAsync(this, CanvasRenderMode.Screen, "FUSEE PointcloudEditor Example");
