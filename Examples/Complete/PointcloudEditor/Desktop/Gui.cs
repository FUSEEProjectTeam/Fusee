...
{
    [FuseeApplication(Name = "FUSEE PointcloudEditor",
        Description = "A tool to edit Pointclouds with Fusee.")]
    public class Gui : RenderCanvas
    {
