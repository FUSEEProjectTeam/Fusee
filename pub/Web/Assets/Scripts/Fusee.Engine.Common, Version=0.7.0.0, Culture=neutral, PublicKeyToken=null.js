...
'use strict';
var $asm03 = JSIL.DeclareAssembly("Fusee.Engine.Common, Version=0.7.0.0, Culture=neutral, PublicKeyToken=null");

JSIL.DeclareNamespace("Fusee");
JSIL.DeclareNamespace("Fusee.Engine");
JSIL.DeclareNamespace("Fusee.Engine.Core");
/* class Fusee.Engine.Core.TextureComponent */ 

(function TextureComponent$Members () {
  var $, $thisType;
  var $T00 = function () {
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IInputDeviceImp", true, [], function ($) {
    ...
    $.Method({}, "get_AxisImpDesc", JSIL.MethodSignature.Return($asm0F.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm03.TypeRef("Fusee.Engine.Common.AxisImpDescription")])));
    $.Method({}, "GetAxis", new JSIL.MethodSignature($.Single, [$.Int32]));
    $.Method({}, "add_AxisValueChanged", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.AxisValueChangedArgs")])));
    $.Method({}, "remove_AxisValueChanged", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.AxisValueChangedArgs")])));
    $.Method({}, "get_ButtonCount", JSIL.MethodSignature.Return($.Int32));
    $.Method({}, "get_ButtonImpDesc", JSIL.MethodSignature.Return($asm0F.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm03.TypeRef("Fusee.Engine.Common.ButtonImpDescription")])));
    $.Method({}, "GetButton", new JSIL.MethodSignature($.Boolean, [$.Int32]));
    $.Method({}, "add_ButtonValueChanged", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.ButtonValueChangedArgs")])));
    $.Method({}, "remove_ButtonValueChanged", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.ButtonValueChangedArgs")])));
    $.Property({}, "Id");
    $.Property({}, "Desc");
    $.Property({}, "Category");
    $.Property({}, "AxesCount");
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IInputDriverImp", true, [], function ($) {
    $.Method({}, "get_Devices", JSIL.MethodSignature.Return($asm0F.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm03.TypeRef("Fusee.Engine.Common.IInputDeviceImp")])));
    $.Method({}, "get_DriverId", JSIL.MethodSignature.Return($.String));
    $.Method({}, "get_DriverDesc", JSIL.MethodSignature.Return($.String));
    $.Method({}, "add_NewDeviceConnected", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.NewDeviceImpConnectedArgs")])));
    $.Method({}, "remove_NewDeviceConnected", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.NewDeviceImpConnectedArgs")])));
    $.Method({}, "add_DeviceDisconnected", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.DeviceImpDisconnectedArgs")])));
    $.Method({}, "remove_DeviceDisconnected", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.DeviceImpDisconnectedArgs")])));
    $.Property({}, "Devices");
    $.Property({}, "DriverId");
    $.Property({}, "DriverDesc");
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IBoxShapeImp", true, [], function ($) {
    $.Method({}, "get_HalfExtents", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.ICollisionShapeImp", true, [], function ($) {
    ...
    $.Method({}, "get_LocalScaling", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_LocalScaling", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.ICompoundShapeImp", true, [], function ($) {
    $.Method({}, "AddChildShape", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm03.TypeRef("Fusee.Engine.Common.IBoxShapeImp")]));
    $.Method({}, "AddChildShape", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm03.TypeRef("Fusee.Engine.Common.ISphereShapeImp")]));
    $.Method({}, "AddChildShape", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm03.TypeRef("Fusee.Engine.Common.ICapsuleShapeImp")]));
    $.Method({}, "AddChildShape", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm03.TypeRef("Fusee.Engine.Common.IConeShapeImp")]));
    $.Method({}, "AddChildShape", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm03.TypeRef("Fusee.Engine.Common.ICylinderShapeImp")]));
    $.Method({}, "AddChildShape", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm03.TypeRef("Fusee.Engine.Common.IMultiSphereShapeImp")]));
    $.Method({}, "AddChildShape", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm03.TypeRef("Fusee.Engine.Common.IEmptyShapeImp")]));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IConeTwistConstraintImp", true, [], function ($) {
    $.Method({}, "get_AFrame", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_BFrame", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    ...
    $.Method({}, "get_FrameOffsetA", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_FrameOffsetB", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "GetPointForAngle", new JSIL.MethodSignature($asm0A.TypeRef("Fusee.Math.Core.float3"), [$.Single, $.Single]));
    ...
    $.Method({}, "SetMotorTarget", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.Quaternion")));
    $.Method({}, "SetMotorTargetInConstraintSpace", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.Quaternion")));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IConvexHullShapeImp", true, [], function ($) {
    $.Method({}, "AddPoint", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "GetScaledPoint", new JSIL.MethodSignature($asm0A.TypeRef("Fusee.Math.Core.float3"), [$.Int32]));
    $.Method({}, "GetUnscaledPoints", JSIL.MethodSignature.Return($jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float3")])));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IDynamicWorldImp", true, [], function ($) {
    $.Method({}, "get_Gravity", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_Gravity", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "AddRigidBody", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IRigidBodyImp"), [
          ...
          $asm0A.TypeRef("Fusee.Math.Core.float3"), $asm03.TypeRef("Fusee.Engine.Common.ICollisionShapeImp")
        ]));
    ...
    $.Method({}, "AddPoint2PointConstraint", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IPoint2PointConstraintImp"), [$asm03.TypeRef("Fusee.Engine.Common.IRigidBodyImp"), $asm0A.TypeRef("Fusee.Math.Core.float3")]));
    ...
    $.Method({}, "AddHingeConstraint", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IHingeConstraintImp"), [
          $asm03.TypeRef("Fusee.Engine.Common.IRigidBodyImp"), $asm0A.TypeRef("Fusee.Math.Core.float4x4"), 
          $.Boolean
        ]));
    $.Method({}, "AddHingeConstraint", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IHingeConstraintImp"), [
          $asm03.TypeRef("Fusee.Engine.Common.IRigidBodyImp"), $asm0A.TypeRef("Fusee.Math.Core.float3"), 
    ...
    $.Method({}, "AddConeTwistConstraint", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IConeTwistConstraintImp"), [$asm03.TypeRef("Fusee.Engine.Common.IRigidBodyImp"), $asm0A.TypeRef("Fusee.Math.Core.float4x4")]));
    ...
    $.Method({}, "AddBoxShape", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IBoxShapeImp"), [$asm0A.TypeRef("Fusee.Math.Core.float3")]));
    ...
    $.Method({}, "AddCylinderShape", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.ICylinderShapeImp"), [$asm0A.TypeRef("Fusee.Math.Core.float3")]));
    ...
    $.Method({}, "AddMultiSphereShape", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IMultiSphereShapeImp"), [$jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float3")]), $jsilcore.TypeRef("System.Array", [$.Single])]));
    ...
    $.Method({}, "AddConvexHullShape", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IConvexHullShapeImp"), [$jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float3")]), $.Boolean]));
    $.Method({}, "AddStaticPlaneShape", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IStaticPlaneShapeImp"), [$asm0A.TypeRef("Fusee.Math.Core.float3"), $.Single]));
    $.Method({}, "AddGImpactMeshShape", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.IGImpactMeshShapeImp"), [$jsilcore.TypeRef("System.Array", [$.Int32]), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float3")])]));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IGeneric6DofConstraintImp", true, [], function ($) {
    $.Method({}, "get_AngularLowerLimit", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_AngularLowerLimit", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_AngularUpperLimit", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_AngularUpperLimit", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "CalcAnchorPos", JSIL.MethodSignature.Void);
    $.Method({}, "CalculateTransforms", JSIL.MethodSignature.Void);
    $.Method({}, "CalculateTransforms", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm0A.TypeRef("Fusee.Math.Core.float4x4")]));
    $.Method({}, "get_CalculatedTransformA", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_CalculatedTransformB", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_FrameOffsetA", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "set_FrameOffsetA", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_FrameOffsetB", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "set_FrameOffsetB", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "GetAngle", new JSIL.MethodSignature($.Single, [$.Int32]));
    $.Method({}, "GetAxis", new JSIL.MethodSignature($asm0A.TypeRef("Fusee.Math.Core.float3"), [$.Int32]));
    ...
    $.Method({}, "get_LinearLowerLimit", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_LinearLowerLimit", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_LinearUpperLimit", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_LinearUpperLimit", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "SetAxis", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float3"), $asm0A.TypeRef("Fusee.Math.Core.float3")]));
    $.Method({}, "SetFrames", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm0A.TypeRef("Fusee.Math.Core.float4x4")]));
    $.Method({}, "SetLimit", new JSIL.MethodSignature(null, [
          $.Int32, $.Single, 
          $.Single
        ]));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IHingeConstraintImp", true, [], function ($) {
    ...
    $.Method({}, "SetMotorTarget", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.Quaternion"), $.Single]));
    ...
    $.Method({}, "get_FrameA", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_FrameB", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_FrameOffsetA", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_FrameOffsetB", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "SetAxis", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "GetHingeAngle", JSIL.MethodSignature.Return($.Single));
    $.Method({}, "GetHingeAngle", new JSIL.MethodSignature($.Single, [$asm0A.TypeRef("Fusee.Math.Core.float4x4"), $asm0A.TypeRef("Fusee.Math.Core.float4x4")]));
    $.Method({}, "SetLimit", new JSIL.MethodSignature(null, [
          $.Single, $.Single, 
          $.Single, $.Single, 
          $.Single
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IMeshImp", true, [], function ($) {
    ...
    $.Method({}, "get_TangentsSet", JSIL.MethodSignature.Return($.Boolean));
    $.Method({}, "get_BiTangentsSet", JSIL.MethodSignature.Return($.Boolean));
    ...
    $.Property({}, "TangentsSet");
    $.Property({}, "BiTangentsSet");
  }, [])
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IMultiSphereShapeImp", true, [], function ($) {
    $.Method({}, "GetSpherePosition", new JSIL.MethodSignature($asm0A.TypeRef("Fusee.Math.Core.float3"), [$.Int32]));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.INetworkImp", true, [], function ($) {
    ...
    $.Method({}, "get_Connections", JSIL.MethodSignature.Return($asm0F.TypeRef("System.Collections.Generic.List`1", [$asm03.TypeRef("Fusee.Engine.Common.INetworkConnection")])));
    $.Method({}, "GetLocalIp", JSIL.MethodSignature.Return($.String));
    $.Method({}, "get_IncomingMsg", JSIL.MethodSignature.Return($asm0F.TypeRef("System.Collections.Generic.List`1", [$asm03.TypeRef("Fusee.Engine.Common.INetworkMsg")])));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IPoint2PointConstraintImp", true, [], function ($) {
    $.Method({}, "get_PivotInA", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_PivotInA", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_PivotInB", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_PivotInB", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "UpdateRhs", JSIL.MethodSignature.Action($.Single));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IRenderCanvasImp", true, [], function ($) {
    ...
    $.Method({}, "add_Init", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.InitEventArgs")])));
    $.Method({}, "remove_Init", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.InitEventArgs")])));
    $.Method({}, "add_UnLoad", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.InitEventArgs")])));
    $.Method({}, "remove_UnLoad", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.InitEventArgs")])));
    $.Method({}, "add_Render", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.RenderEventArgs")])));
    $.Method({}, "remove_Render", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.RenderEventArgs")])));
    $.Method({}, "add_Resize", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.ResizeEventArgs")])));
    $.Method({}, "remove_Resize", JSIL.MethodSignature.Action($asm0F.TypeRef("System.EventHandler`1", [$asm03.TypeRef("Fusee.Engine.Common.ResizeEventArgs")])));
    $.Property({}, "Width");
    $.Property({}, "Height");
    $.Property({}, "Caption");
    $.Property({}, "DeltaTime");
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IRenderContextImp", true, [], function ($) {
    $.Method({}, "set_ClearColor", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float4")));
    $.Method({}, "get_ClearColor", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4")));
    ...
    $.Method({}, "RemoveShader", JSIL.MethodSignature.Action($asm03.TypeRef("Fusee.Engine.Common.IShaderProgramImp")));
    $.Method({}, "GetShaderParamList", new JSIL.MethodSignature($asm0F.TypeRef("System.Collections.Generic.IList`1", [$asm03.TypeRef("Fusee.Engine.Common.ShaderParamInfo")]), [$asm03.TypeRef("Fusee.Engine.Common.IShaderProgramImp")]));
    ...
    $.Method({OriginalName: "SetShaderParam"}, "SetShaderParam2f", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IShaderParam"), $asm0A.TypeRef("Fusee.Math.Core.float2")]));
    $.Method({OriginalName: "SetShaderParam"}, "SetShaderParam3f", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IShaderParam"), $asm0A.TypeRef("Fusee.Math.Core.float3")]));
    $.Method({OriginalName: "SetShaderParam"}, "SetShaderParam4f", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IShaderParam"), $asm0A.TypeRef("Fusee.Math.Core.float4")]));
    $.Method({OriginalName: "SetShaderParam"}, "SetShaderParam4fArray", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IShaderParam"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float4")])]));
    $.Method({OriginalName: "SetShaderParam"}, "SetShaderParamfloat4x4", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IShaderParam"), $asm0A.TypeRef("Fusee.Math.Core.float4x4")]));
    $.Method({OriginalName: "SetShaderParam"}, "SetShaderParamMtx4fArray", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IShaderParam"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float4x4")])]));
    ...
    $.Method({}, "SetShaderParamTexture", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IShaderParam"), $asm03.TypeRef("Fusee.Engine.Common.ITextureHandle")]));
    ...
    $.Method({}, "UpdateTextureFromVideoStream", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IVideoStreamImp"), $asm03.TypeRef("Fusee.Engine.Common.ITextureHandle")]));
    ...
    $.Method({}, "CreateTexture", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.ITextureHandle"), [$asm03.TypeRef("Fusee.Engine.Common.ITexture"), $.Boolean]));
    $.Method({}, "RemoveTextureHandle", JSIL.MethodSignature.Action($asm03.TypeRef("Fusee.Engine.Common.ITextureHandle")));
    $.Method({}, "CopyDepthBufferFromDeferredBuffer", JSIL.MethodSignature.Action($asm03.TypeRef("Fusee.Engine.Common.ITextureHandle")));
    $.Method({}, "CreateWritableTexture", new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.ITextureHandle"), [
          $.Int32, $.Int32, 
    ...
    $.Method({}, "SetVertices", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IMeshImp"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float3")])]));
    $.Method({}, "SetTangents", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IMeshImp"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float4")])]));
    $.Method({}, "SetBiTangents", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IMeshImp"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float3")])]));
    $.Method({}, "SetNormals", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IMeshImp"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float3")])]));
    $.Method({}, "SetUVs", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IMeshImp"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float2")])]));
    ...
    $.Method({}, "SetBoneIndices", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IMeshImp"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float4")])]));
    $.Method({}, "SetBoneWeights", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.IMeshImp"), $jsilcore.TypeRef("System.Array", [$asm0A.TypeRef("Fusee.Math.Core.float4")])]));
    ...
    $.Method({}, "RemoveTangents", JSIL.MethodSignature.Action($asm03.TypeRef("Fusee.Engine.Common.IMeshImp")));
    $.Method({}, "RemoveBiTangents", JSIL.MethodSignature.Action($asm03.TypeRef("Fusee.Engine.Common.IMeshImp")));
    ...
    $.Method({}, "GetBufferContent", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.Rectangle"), $asm03.TypeRef("Fusee.Engine.Common.ITextureHandle")]));
    ...
    $.Method({}, "SetRenderTarget", JSIL.MethodSignature.Action($asm03.TypeRef("Fusee.Engine.Common.ITextureHandle")));
    $.Method({}, "SetCubeMapRenderTarget", new JSIL.MethodSignature(null, [$asm03.TypeRef("Fusee.Engine.Common.ITextureHandle"), $.Int32]));
    $.Method({}, "GetPixelColor", new JSIL.MethodSignature($asm00.TypeRef("Fusee.Base.Common.IImageData"), [
          $.Int32, $.Int32, 
          $.Int32, $.Int32
        ]));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IRigidBodyImp", true, [], function ($) {
    ...
    $.Method({}, "get_Inertia", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_Inertia", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_WorldTransform", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "set_WorldTransform", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float4x4")));
    $.Method({}, "get_Position", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_Position", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_Rotation", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.Quaternion")));
    $.Method({}, "ApplyForce", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float3"), $asm0A.TypeRef("Fusee.Math.Core.float3")]));
    $.Method({}, "ApplyImpulse", new JSIL.MethodSignature(null, [$asm0A.TypeRef("Fusee.Math.Core.float3"), $asm0A.TypeRef("Fusee.Math.Core.float3")]));
    $.Method({}, "ApplyTorque", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "ApplyTorqueImpulse", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "ApplyCentralForce", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "ApplyCentralImpulse", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_LinearVelocity", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_LinearVelocity", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_AngularVelocity", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_AngularVelocity", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_LinearFactor", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_LinearFactor", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_AngularFactor", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "set_AngularFactor", JSIL.MethodSignature.Action($asm0A.TypeRef("Fusee.Math.Core.float3")));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.ISliderConstraintImp", true, [], function ($) {
    $.Method({}, "get_AnchorInA", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
    $.Method({}, "get_AnchorInB", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IStaticPlaneShapeImp", true, [], function ($) {
    ...
    $.Method({}, "get_PlaneNormal", JSIL.MethodSignature.Return($asm0A.TypeRef("Fusee.Math.Core.float3")));
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.ITexture", true, [], function ($) {
    $.Method({}, "get_PixelData", JSIL.MethodSignature.Return($jsilcore.TypeRef("System.Array", [$.Byte])));
    $.Property({}, "PixelData");
  }, [$asm00.TypeRef("Fusee.Base.Common.IImageData")]);

/* interface Fusee.Engine.Common.ITextureHandle */ 

JSIL.MakeInterface(
  "Fusee.Engine.Common.ITextureHandle", true, [], function ($) {
  }, []);
...
JSIL.MakeInterface(
  "Fusee.Engine.Common.IVideoStreamImp", true, [], function ($) {
    $.Method({}, "GetCurrentFrame", JSIL.MethodSignature.Return($asm03.TypeRef("Fusee.Engine.Common.ITexture")));
...
(function Light$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "Position", $asm0A.TypeRef("Fusee.Math.Core.float4"));
...
/* class Fusee.Engine.Common.NamespaceDoc */ 

(function NamespaceDoc$Members () {
  var $, $thisType;

  JSIL.MakeStaticClass("Fusee.Engine.Common.NamespaceDoc", false, [], function ($ib) {
    $ = $ib;
...
(function ShaderParamInfo$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "Type", $asm0F.TypeRef("System.Type"));
